...
class TestRetrieverResponseFinalResultsInner(unittest.TestCase):
    """RetrieverResponseFinalResultsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetrieverResponseFinalResultsInner:
        """Test RetrieverResponseFinalResultsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetrieverResponseFinalResultsInner`
        """
        model = RetrieverResponseFinalResultsInner()
        if include_optional:
            return RetrieverResponseFinalResultsInner(
                document_id = '',
                collection_id = '',
                object_id = '',
    ...
    def testRetrieverResponseFinalResultsInner(self):
        """Test RetrieverResponseFinalResultsInner"""
