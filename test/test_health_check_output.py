...
class TestHealthCheckOutput(unittest.TestCase):
    """HealthCheckOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthCheckOutput:
        """Test HealthCheckOutput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HealthCheckOutput`
        """
        model = HealthCheckOutput()
        if include_optional:
    ...
    def testHealthCheckOutput(self):
        """Test HealthCheckOutput"""
