...
class TestHierarchicalTaxonomyConfigInput(unittest.TestCase):
    """HierarchicalTaxonomyConfigInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HierarchicalTaxonomyConfigInput:
        """Test HierarchicalTaxonomyConfigInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HierarchicalTaxonomyConfigInput`
        """
        model = HierarchicalTaxonomyConfigInput()
        if include_optional:
    ...
    def testHierarchicalTaxonomyConfigInput(self):
        """Test HierarchicalTaxonomyConfigInput"""
