    ...
    def make_instance(self, include_optional) -> Parameters:
        ...
        if include_optional:
            return Parameters(
                ...
                video_deduplication_threshold = 0,
                ...
                rotate_proxy_every_n_requests = 0,
