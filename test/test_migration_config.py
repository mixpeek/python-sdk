...
class TestMigrationConfig(unittest.TestCase):
    """MigrationConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MigrationConfig:
        """Test MigrationConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MigrationConfig`
        """
