...
class TestErrorBreakdown(unittest.TestCase):
    """ErrorBreakdown unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorBreakdown:
        """Test ErrorBreakdown
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorBreakdown`
        """
        model = ErrorBreakdown()
        if include_optional:
