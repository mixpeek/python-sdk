...
class TestIndexSuggestion(unittest.TestCase):
    """IndexSuggestion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IndexSuggestion:
        """Test IndexSuggestion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndexSuggestion`
        """
        model = IndexSuggestion()
        if include_optional:
