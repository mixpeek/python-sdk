...
*CollectionLifecycleApi* | [**get_lifecycle**](docs/CollectionLifecycleApi.md#get_lifecycle) | **GET** /v1/collections/{collection_identifier}/lifecycle | Get Lifecycle Status
*CollectionLifecycleApi* | [**transition_lifecycle**](docs/CollectionLifecycleApi.md#transition_lifecycle) | **PATCH** /v1/collections/{collection_identifier}/lifecycle | Transition Lifecycle
...
*CustomPluginsNamespaceApi* | [**reconfigure_namespace_id_plugins**](docs/CustomPluginsNamespaceApi.md#reconfigure_namespace_id_plugins) | **POST** /v1/namespaces/{namespace_id}/plugins/reconfigure | Reconfigure namespace Qdrant schema
*CustomPluginsNamespaceApi* | [**test_realtime_inference_namespaces_id_plugins**](docs/CustomPluginsNamespaceApi.md#test_realtime_inference_namespaces_id_plugins) | **POST** /v1/namespaces/{namespace_id}/plugins/{plugin_id}/realtime/test | Test plugin realtime inference
...
*DiscoveryApi* | [**get_all_discovery**](docs/DiscoveryApi.md#get_all_discovery) | **GET** /v1/discovery | Get All Discovery Information
*DiscoveryApi* | [**get_manifest_schema_discovery**](docs/DiscoveryApi.md#get_manifest_schema_discovery) | **GET** /v1/discovery/schema | Get Manifest Schema for Agent Configuration
*DiscoveryApi* | [**list_extractors_discovery**](docs/DiscoveryApi.md#list_extractors_discovery) | **GET** /v1/discovery/extractors | List Available Feature Extractors
*DiscoveryApi* | [**list_stages_with_examples_discovery**](docs/DiscoveryApi.md#list_stages_with_examples_discovery) | **GET** /v1/discovery/stages | List Available Retriever Stages with Examples
...
*DocumentsApi* | [**get_document_ns**](docs/DocumentsApi.md#get_document_ns) | **GET** /v1/documents/{document_id} | Get a document by ID (namespace-scoped).
*DocumentsApi* | [**patch_document_ns**](docs/DocumentsApi.md#patch_document_ns) | **PATCH** /v1/documents/{document_id} | Partially update a document by ID (namespace-scoped).
*DocumentsApi* | [**update_document_ns**](docs/DocumentsApi.md#update_document_ns) | **PUT** /v1/documents/{document_id} | Update a document by ID (namespace-scoped).
...
*HealthApi* | [**celery_beat_health**](docs/HealthApi.md#celery_beat_health) | **GET** /v1/health/beat | Celery Beat Health
*HealthApi* | [**celery_beat_health_0**](docs/HealthApi.md#celery_beat_health_0) | **GET** /v1/health/beat | Celery Beat Health
...
*ManifestApi* | [**lint_manifest**](docs/ManifestApi.md#lint_manifest) | **POST** /v1/manifest/lint | Lint Manifest
*ManifestApi* | [**validate_manifest**](docs/ManifestApi.md#validate_manifest) | **POST** /v1/manifest/validate | Validate Manifest
*MarketplaceApi* | [**cancel_subscription_marketplace**](docs/MarketplaceApi.md#cancel_subscription_marketplace) | **DELETE** /v1/marketplace/subscriptions/{subscription_id} | Cancel Subscription
*MarketplaceApi* | [**create_marketplace_listing**](docs/MarketplaceApi.md#create_marketplace_listing) | **POST** /v1/marketplace/listings | Create Marketplace Listing
*MarketplaceApi* | [**create_subscription_marketplace**](docs/MarketplaceApi.md#create_subscription_marketplace) | **POST** /v1/marketplace/subscriptions | Subscribe to Marketplace Listing
*MarketplaceApi* | [**delete_marketplace_listing**](docs/MarketplaceApi.md#delete_marketplace_listing) | **DELETE** /v1/marketplace/listings/{listing_id} | Delete Marketplace Listing
*MarketplaceApi* | [**execute_marketplace_retriever_catalog_name**](docs/MarketplaceApi.md#execute_marketplace_retriever_catalog_name) | **POST** /v1/marketplace/catalog/{public_name}/execute | Execute Marketplace Retriever
*MarketplaceApi* | [**get_marketplace_catalog**](docs/MarketplaceApi.md#get_marketplace_catalog) | **GET** /v1/marketplace/catalog | Browse Marketplace Catalog
*MarketplaceApi* | [**get_marketplace_listing_by_name_catalog**](docs/MarketplaceApi.md#get_marketplace_listing_by_name_catalog) | **GET** /v1/marketplace/catalog/{public_name} | Get Marketplace Listing by Public Name
*MarketplaceApi* | [**get_marketplace_listing_config_catalog_name**](docs/MarketplaceApi.md#get_marketplace_listing_config_catalog_name) | **GET** /v1/marketplace/catalog/{public_name}/config | Get Marketplace Listing Configuration
*MarketplaceApi* | [**get_marketplace_listing_template_catalog_name**](docs/MarketplaceApi.md#get_marketplace_listing_template_catalog_name) | **GET** /v1/marketplace/catalog/{public_name}/template | Get Marketplace Listing as Template
*MarketplaceApi* | [**get_subscription_marketplace**](docs/MarketplaceApi.md#get_subscription_marketplace) | **GET** /v1/marketplace/subscriptions/{subscription_id} | Get Subscription Details
*MarketplaceApi* | [**list_my_subscriptions_marketplace**](docs/MarketplaceApi.md#list_my_subscriptions_marketplace) | **GET** /v1/marketplace/subscriptions | List My Subscriptions
*MarketplaceApi* | [**publish_marketplace_listing**](docs/MarketplaceApi.md#publish_marketplace_listing) | **PATCH** /v1/marketplace/listings/{listing_id}/publish | Publish Marketplace Listing
*MarketplaceApi* | [**update_marketplace_listing**](docs/MarketplaceApi.md#update_marketplace_listing) | **PATCH** /v1/marketplace/listings/{listing_id} | Update Marketplace Listing
*MarketplaceApi* | [**verify_marketplace_listing_password_catalog_name**](docs/MarketplaceApi.md#verify_marketplace_listing_password_catalog_name) | **POST** /v1/marketplace/catalog/{public_name}/verify | Verify Password for Marketplace Listing
...
*OrganizationBillingApi* | [**generate_invoice_now_organizations_billing**](docs/OrganizationBillingApi.md#generate_invoice_now_organizations_billing) | **POST** /v1/organizations/billing/generate-invoice | Generate Invoice Now
...
*PagesApi* | [**create_page**](docs/PagesApi.md#create_page) | **POST** /v1/pages | Create a Page
*PagesApi* | [**delete_page**](docs/PagesApi.md#delete_page) | **DELETE** /v1/pages/{page_id} | Delete a Page
*PagesApi* | [**get_page**](docs/PagesApi.md#get_page) | **GET** /v1/pages/{page_id} | Get a Page
*PagesApi* | [**list_pages**](docs/PagesApi.md#list_pages) | **GET** /v1/pages | List Pages
*PagesApi* | [**update_page**](docs/PagesApi.md#update_page) | **PATCH** /v1/pages/{page_id} | Update a Page
...
*PrivateApi* | [**accept_invitation_organizations**](docs/PrivateApi.md#accept_invitation_organizations) | **POST** /v1/private/organizations/invitations/accept | Accept Invitation
...
*PrivateApi* | [**get_pending_invitations_organizations_email**](docs/PrivateApi.md#get_pending_invitations_organizations_email) | **GET** /v1/private/organizations/invitations/{email} | Get Pending Invitations
...
*PrivateApi* | [**remove_user_from_organization**](docs/PrivateApi.md#remove_user_from_organization) | **POST** /v1/private/organizations/remove-user | Remove User From Organization Private
...
*PublicPagesAPIApi* | [**execute_page_search_slug**](docs/PublicPagesAPIApi.md#execute_page_search_slug) | **POST** /v1/public/pages/{slug}/search | Execute a Page tab search
*PublicPagesAPIApi* | [**get_page_config_slug**](docs/PublicPagesAPIApi.md#get_page_config_slug) | **GET** /v1/public/pages/{slug} | Get public Page config
*PublicPagesAPIApi* | [**get_page_gallery_slug**](docs/PublicPagesAPIApi.md#get_page_gallery_slug) | **GET** /v1/public/pages/{slug}/gallery | Get Page featured gallery
...
*QuickstartApi* | [**provision_docs_search_quickstart**](docs/QuickstartApi.md#provision_docs_search_quickstart) | **POST** /v1/quickstart/docs-search | Provision Docs Search
*ResourceSearchApi* | [**search_resources**](docs/ResourceSearchApi.md#search_resources) | **POST** /v1/resources/search | Search Resources
*RetrieverAPIKeysApi* | [**create_retriever_key**](docs/RetrieverAPIKeysApi.md#create_retriever_key) | **POST** /v1/retrievers/{retriever_id}/api-keys | Create Retriever API Key
*RetrieverAPIKeysApi* | [**list_retriever_keys**](docs/RetrieverAPIKeysApi.md#list_retriever_keys) | **GET** /v1/retrievers/{retriever_id}/api-keys | List Retriever API Keys
*RetrieverAPIKeysApi* | [**revoke_retriever_key**](docs/RetrieverAPIKeysApi.md#revoke_retriever_key) | **DELETE** /v1/retrievers/{retriever_id}/api-keys/{key_id} | Revoke Retriever API Key
...
*RetrieversApi* | [**list_retrievers_get**](docs/RetrieversApi.md#list_retrievers_get) | **GET** /v1/retrievers | List Retrievers Get
...
## Documentation For Models
 ...
 - [BodyCreateSubscriptionV1MarketplaceSubscriptionsPost](docs/BodyCreateSubscriptionV1MarketplaceSubscriptionsPost.md)
 - [BodyGenerateInvoiceNowV1OrganizationsBillingGenerateInvoicePost](docs/BodyGenerateInvoiceNowV1OrganizationsBillingGenerateInvoicePost.md)
 - [BodyVerifyMarketplaceListingPasswordV1MarketplaceCatalogPublicNameVerifyPost](docs/BodyVerifyMarketplaceListingPasswordV1MarketplaceCatalogPublicNameVerifyPost.md)
 ...
 - [BoxCCGCredentials](docs/BoxCCGCredentials.md)
 - [BoxConfig](docs/BoxConfig.md)
 - [BoxJWTCredentials](docs/BoxJWTCredentials.md)
 - [BoxOAuthCredentials](docs/BoxOAuthCredentials.md)
 ...
 - [CollectionScheduleConfig](docs/CollectionScheduleConfig.md)
 ...
 - [CreateRetrieverAPIKeyRequest](docs/CreateRetrieverAPIKeyRequest.md)
 ...
 - [Credentials4](docs/Credentials4.md)
 ...
 - [DocsSearchOptions](docs/DocsSearchOptions.md)
 - [DocsSearchRequest](docs/DocsSearchRequest.md)
 - [DocsSearchResponse](docs/DocsSearchResponse.md)
 ...
 - [EnrichmentInputMapping](docs/EnrichmentInputMapping.md)
 ...
 - [ExtractorDiscovery](docs/ExtractorDiscovery.md)
 ...
 - [FeaturedGalleryConfigInput](docs/FeaturedGalleryConfigInput.md)
 - [FeaturedGalleryConfigOutput](docs/FeaturedGalleryConfigOutput.md)
 ...
 - [HTTPAPIConfig](docs/HTTPAPIConfig.md)
 - [HTTPAPIHeaderCredentials](docs/HTTPAPIHeaderCredentials.md)
 ...
 - [InstagramOAuthCredentials](docs/InstagramOAuthCredentials.md)
 ...
 - [LifecycleStatusResponse](docs/LifecycleStatusResponse.md)
 - [LineageStep](docs/LineageStep.md)
 - [LintResponse](docs/LintResponse.md)
 ...
 - [ListPagesResponse](docs/ListPagesResponse.md)
 ...
 - [ListingVisibility](docs/ListingVisibility.md)
 ...
 - [ManifestSchemaDiscovery](docs/ManifestSchemaDiscovery.md)
 ...
 - [PageTabInput](docs/PageTabInput.md)
 - [PageTabOutput](docs/PageTabOutput.md)
 ...
 - [PluginRealtimeTestRequest](docs/PluginRealtimeTestRequest.md)
 - [PluginRealtimeTestResponse](docs/PluginRealtimeTestResponse.md)
 ...
 - [PublicPageConfigResponse](docs/PublicPageConfigResponse.md)
 - [PublicPageSearchRequest](docs/PublicPageSearchRequest.md)
 ...
 - [Query](docs/Query.md)
 - [RSSConfig](docs/RSSConfig.md)
 - [RSSFieldSource](docs/RSSFieldSource.md)
 - [RSSHttpHeaderCredentials](docs/RSSHttpHeaderCredentials.md)
 ...
 - [ReconfigureNamespaceRequest](docs/ReconfigureNamespaceRequest.md)
 - [ReconfigureNamespaceResponse](docs/ReconfigureNamespaceResponse.md)
 ...
 - [RetrieverAPIKeyListResponse](docs/RetrieverAPIKeyListResponse.md)
 - [RetrieverAPIKeyResponse](docs/RetrieverAPIKeyResponse.md)
 - [RetrieverConfig](docs/RetrieverConfig.md)
 - [RetrieverEnrichmentConfigInput](docs/RetrieverEnrichmentConfigInput.md)
 - [RetrieverEnrichmentConfigOutput](docs/RetrieverEnrichmentConfigOutput.md)
 ...
 - [RetrieverVisibility](docs/RetrieverVisibility.md)
 - [RetryBatchRequest](docs/RetryBatchRequest.md)
 - [ReturnVectorNames](docs/ReturnVectorNames.md)
 ...
 - [SectionConfig](docs/SectionConfig.md)
 ...
 - [StageDefsAggregationFunction](docs/StageDefsAggregationFunction.md)
 - [StageDefsAggregationOperation](docs/StageDefsAggregationOperation.md)
 - [StageDefsAuthConfig](docs/StageDefsAuthConfig.md)
 - [StageDefsAuthType](docs/StageDefsAuthType.md)
 - [StageDefsCitationConfig](docs/StageDefsCitationConfig.md)
 - [StageDefsContentInput](docs/StageDefsContentInput.md)
 - [StageDefsContentQueryInput](docs/StageDefsContentQueryInput.md)
 - [StageDefsDiversityFeatureConfig](docs/StageDefsDiversityFeatureConfig.md)
 - [StageDefsDocumentQueryInput](docs/StageDefsDocumentQueryInput.md)
 - [StageDefsDocumentReference](docs/StageDefsDocumentReference.md)
 - [StageDefsDynamicValue](docs/StageDefsDynamicValue.md)
 - [StageDefsEnrichmentField](docs/StageDefsEnrichmentField.md)
 - [StageDefsEnrichmentMergeMode](docs/StageDefsEnrichmentMergeMode.md)
 - [StageDefsErrorHandling](docs/StageDefsErrorHandling.md)
 - [StageDefsFacetFieldConfig](docs/StageDefsFacetFieldConfig.md)
 - [StageDefsFeatureSearchConfig](docs/StageDefsFeatureSearchConfig.md)
 - [StageDefsFeatureSearchGroupBy](docs/StageDefsFeatureSearchGroupBy.md)
 - [StageDefsFilterCondition](docs/StageDefsFilterCondition.md)
 - [StageDefsFilterOperator](docs/StageDefsFilterOperator.md)
 - [StageDefsFusionStrategy](docs/StageDefsFusionStrategy.md)
 - [StageDefsGroupByFieldConfig](docs/StageDefsGroupByFieldConfig.md)
 - [StageDefsLLMProvider](docs/StageDefsLLMProvider.md)
 - [StageDefsLearnedFusionConfig](docs/StageDefsLearnedFusionConfig.md)
 - [StageDefsLearningAlgorithm](docs/StageDefsLearningAlgorithm.md)
 - [StageDefsLogicalOperator](docs/StageDefsLogicalOperator.md)
 - [StageDefsOnEmptyBehavior](docs/StageDefsOnEmptyBehavior.md)
 - [StageDefsOnNoResults](docs/StageDefsOnNoResults.md)
 - [StageDefsQueryPreprocessing](docs/StageDefsQueryPreprocessing.md)
 - [StageDefsRateLimitConfig](docs/StageDefsRateLimitConfig.md)
 - [StageDefsResultHandling](docs/StageDefsResultHandling.md)
 - [StageDefsSortDirection](docs/StageDefsSortDirection.md)
 - [StageDefsStageCacheBehavior](docs/StageDefsStageCacheBehavior.md)
 - [StageDefsTextQueryInput](docs/StageDefsTextQueryInput.md)
 - [StageDefsURLPatterns](docs/StageDefsURLPatterns.md)
 - [StageDefsVectorQueryInput](docs/StageDefsVectorQueryInput.md)
 - [StageDiscovery](docs/StageDiscovery.md)
 ...
 - [SubscriptionTierConfig](docs/SubscriptionTierConfig.md)
 ...
 - [WriteBackFieldMapping](docs/WriteBackFieldMapping.md)
