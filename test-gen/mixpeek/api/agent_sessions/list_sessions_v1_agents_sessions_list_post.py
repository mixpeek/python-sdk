...
from ...models.list_sessions_request import ListSessionsRequest
...
def _get_kwargs(
    *,
    body: ListSessionsRequest | Unset = UNSET,
...
) -> ErrorResponse | HTTPValidationError | ListSessionsResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | HTTPValidationError | ListSessionsResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (ListSessionsRequest | Unset): Request payload for listing sessions.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | HTTPValidationError | ListSessionsResponse
     """
