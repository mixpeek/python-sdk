...
from ...models.patch_batch_request import PatchBatchRequest
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (PatchBatchRequest): Request model for partially updating a batch (PATCH operation).
