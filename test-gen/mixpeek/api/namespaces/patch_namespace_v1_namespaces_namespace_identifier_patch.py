...
from ...models.patch_namespace_request import PatchNamespaceRequest
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (PatchNamespaceRequest): Request schema for partially updating a namespace (PATCH
            operation).
