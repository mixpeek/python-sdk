...
from ...models.list_namespaces_request import ListNamespacesRequest
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: ListNamespacesRequest | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (ListNamespacesRequest | Unset): Request schema for listing namespaces.
