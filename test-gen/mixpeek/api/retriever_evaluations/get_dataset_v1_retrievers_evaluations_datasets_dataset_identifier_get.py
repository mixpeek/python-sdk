...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/retrievers/evaluations/datasets/{dataset_identifier}".format(
            dataset_identifier=quote(str(dataset_identifier), safe=""),
        ),
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = EvaluationDataset.from_dict(response.json())
