...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/analytics/retrievers/{retriever_id}/cache-performance".format(
...
def sync_detailed(
    ...
    **Example:**
    ```bash
    curl -X GET \"https://api.mixpeek.com/v1/analytics/retrievers/ret_abc123/cache-
    performance?hours=168\" \
