...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/analytics/performance/engine/extractors",
        "params": params,
    }
...
def sync_detailed(
    ...
    **Example:**
    ...
    Args:
        hours (int | None | Unset): Hours of history
        start_date (datetime.datetime | None | Unset): Start date
        end_date (datetime.datetime | None | Unset): End date
