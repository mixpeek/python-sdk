...
from ...models.organization_admin_update_request import OrganizationAdminUpdateRequest
...
def _get_kwargs(
    ...
    *,
    body: OrganizationAdminUpdateRequest,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        organization_identifier (str):
        body (OrganizationAdminUpdateRequest): Admin-only update payload for organization.
