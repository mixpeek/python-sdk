...
T = TypeVar("T", bound="BucketSchemaFieldPropertiesType0")


@_attrs_define
class BucketSchemaFieldPropertiesType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        bucket_schema_field_properties_type_0 = cls()
        ...
        bucket_schema_field_properties_type_0.additional_properties = additional_properties
        return bucket_schema_field_properties_type_0
