...
from ...models.create_retriever_request import CreateRetrieverRequest
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (CreateRetrieverRequest): Payload for creating a new retriever.
