...
from ...models.list_retrievers_request import ListRetrieversRequest
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: ListRetrieversRequest | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (ListRetrieversRequest | Unset): Request to list retrievers.
