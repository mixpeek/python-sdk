...
from ...models.patch_session_request import PatchSessionRequest
from ...models.patch_session_response import PatchSessionResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/agents/sessions/{session_id}".format(
...
) -> ErrorResponse | HTTPValidationError | PatchSessionResponse | None:
    if response.status_code == 200:
        response_200 = PatchSessionResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | HTTPValidationError | PatchSessionResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (PatchSessionRequest): Request payload for updating session metadata.
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | HTTPValidationError | PatchSessionResponse
     """
