...
) -> ErrorResponse | GetSessionResponse | HTTPValidationError | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | GetSessionResponse | HTTPValidationError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | GetSessionResponse | HTTPValidationError
     """
