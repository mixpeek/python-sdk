...
def _get_kwargs(
    ...
    *,
    ...
    json_return_vectors: bool | None | Unset
    if isinstance(return_vectors, Unset):
        json_return_vectors = UNSET
    else:
        json_return_vectors = return_vectors
    params["return_vectors"] = json_return_vectors

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/collections/{collection_identifier}/documents/{document_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        return_vectors (bool | None | Unset):  Default: False.
