...
from ...models.update_published_retriever_request import UpdatePublishedRetrieverRequest
...
def _get_kwargs(
    retriever_id: str,
    *,
    body: UpdatePublishedRetrieverRequest,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (UpdatePublishedRetrieverRequest): Request to update a published retriever
            configuration.
