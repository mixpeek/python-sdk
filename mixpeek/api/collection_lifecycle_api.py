...
class CollectionLifecycleApi:
    ...
    def get_lifecycle(
        self,
        collection_identifier: Annotated[StrictStr, Field(description="Collection ID or name")],
        ...
        :param collection_identifier: Collection ID or name (required)
        ...
        _param = self._get_lifecycle_serialize(
    ...
    @validate_call
    def get_lifecycle_with_http_info(
        self,
        collection_identifier: Annotated[StrictStr, Field(description="Collection ID or name")],
        authorization: Annotated[Optional[StrictStr], Field(description="REQUIRED: Bearer token authentication using your API key. Format: 'Bearer sk_xxxxxxxxxxxxx'. You can create API keys in the Mixpeek dashboard under Organization Settings.")] = None,
        authorization2: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LifecycleStatusResponse]:
        """Get Lifecycle Status
    ...
    @validate_call
    def get_lifecycle_without_preload_content(
        self,
        collection_identifier: Annotated[StrictStr, Field(description="Collection ID or name")],
        authorization: Annotated[Optional[StrictStr], Field(description="REQUIRED: Bearer token authentication using your API key. Format: 'Bearer sk_xxxxxxxxxxxxx'. You can create API keys in the Mixpeek dashboard under Organization Settings.")] = None,
        authorization2: Optional[StrictStr] = None,
    ...
    def _get_lifecycle_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/collections/{collection_identifier}/lifecycle',
    ...
    def transition_lifecycle(
        self,
        collection_identifier: Annotated[StrictStr, Field(description="Collection ID or name")],
        transition_lifecycle_request: TransitionLifecycleRequest,
        authorization: Annotated[Optional[StrictStr], Field(description="REQUIRED: Bearer token authentication using your API key. Format: 'Bearer sk_xxxxxxxxxxxxx'. You can create API keys in the Mixpeek dashboard under Organization Settings.")] = None,
        authorization2: Optional[StrictStr] = None,
        x_namespace: Annotated[Optional[StrictStr], Field(description="REQUIRED: Namespace identifier for scoping this request. All resources (collections, buckets, taxonomies, etc.) are scoped to a namespace. You can provide either the namespace name or namespace ID. Format: ns_xxxxxxxxxxxxx (ID) or a custom name like 'my-namespace'")] = None,
        _request_timeout: Union[
        ...
        :param collection_identifier: Collection ID or name (required)
        :type collection_identifier: str
        :param transition_lifecycle_request: (required)
        :type transition_lifecycle_request: TransitionLifecycleRequest
        :param authorization: REQUIRED: Bearer token authentication using your API key. Format: 'Bearer sk_xxxxxxxxxxxxx'. You can create API keys in the Mixpeek dashboard under Organization Settings.
        :type authorization: str
        :param authorization2:
        :type authorization2: str
        ...
        _param = self._transition_lifecycle_serialize(
            collection_identifier=collection_identifier,
            transition_lifecycle_request=transition_lifecycle_request,
            authorization=authorization,
            authorization2=authorization2,
            x_namespace=x_namespace,
            _request_auth=_request_auth,
    ...
    @validate_call
    def transition_lifecycle_with_http_info(
        self,
        collection_identifier: Annotated[StrictStr, Field(description="Collection ID or name")],
        transition_lifecycle_request: TransitionLifecycleRequest,
        authorization: Annotated[Optional[StrictStr], Field(description="REQUIRED: Bearer token authentication using your API key. Format: 'Bearer sk_xxxxxxxxxxxxx'. You can create API keys in the Mixpeek dashboard under Organization Settings.")] = None,
    ...
    @validate_call
    def transition_lifecycle_without_preload_content(
        self,
        collection_identifier: Annotated[StrictStr, Field(description="Collection ID or name")],
        transition_lifecycle_request: TransitionLifecycleRequest,
        authorization: Annotated[Optional[StrictStr], Field(description="REQUIRED: Bearer token authentication using your API key. Format: 'Bearer sk_xxxxxxxxxxxxx'. You can create API keys in the Mixpeek dashboard under Organization Settings.")] = None,
    ...
    def _transition_lifecycle_serialize(
        self,
        collection_identifier,
        transition_lifecycle_request,
        authorization,
        authorization2,
        x_namespace,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if transition_lifecycle_request is not None:
            _body_params = transition_lifecycle_request
