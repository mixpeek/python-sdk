...
class AnalyticsExtractorsApi:
    ...
    def get_extractor_performance_analytics(
        self,
        extractor_name: Annotated[Optional[StrictStr], Field(description="Filter by extractor")] = None,
        ...
        Get feature extraction performance metrics.  Returns performance metrics for feature extractors including: - Total executions per extractor - Average duration - P95/P99 latencies - Success/failure rates  **Example:** ```bash GET /v1/analytics/extractors/performance?hours=24 GET /v1/analytics/extractors/performance?extractor_name=text_extractor&hours=168 ```

        :param extractor_name: Filter by extractor
    ...
    def _get_extractor_performance_analytics_serialize(
        ...
        if extractor_name is not None:
            ...
            _query_params.append(('extractor_name', extractor_name))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/analytics/extractors/performance',
