...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/buckets/{bucket_identifier}/batches".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (CreateBatchRequest): Request model for creating a new batch.
            ...
            1. Create batch with object_ids → Batch created in DRAFT status, collections auto-
            discovered
