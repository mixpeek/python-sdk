...
from ...models.namespace_summary_response import NamespaceSummaryResponse
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/analytics/namespaces/summary",
        "params": params,
    }
...
) -> ErrorResponse | HTTPValidationError | NamespaceSummaryResponse | None:
    if response.status_code == 200:
        response_200 = NamespaceSummaryResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | HTTPValidationError | NamespaceSummaryResponse]:
    return Response(
...
def sync(
    ...
    **Example:**
    ...
    Returns:
        ErrorResponse | HTTPValidationError | NamespaceSummaryResponse
     """
