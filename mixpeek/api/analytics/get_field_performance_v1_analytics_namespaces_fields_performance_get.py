...
from ...models.field_performance_response import FieldPerformanceResponse
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/analytics/namespaces/fields/performance",
        "params": params,
    }
...
) -> ErrorResponse | FieldPerformanceResponse | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = FieldPerformanceResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | FieldPerformanceResponse | HTTPValidationError]:
    return Response(
...
def sync(
    ...
    **Example:**
    ...
    Returns:
        ErrorResponse | FieldPerformanceResponse | HTTPValidationError
     """
