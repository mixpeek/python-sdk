...
def _get_kwargs(
    *,
    hours: int | Unset = 24,
    limit: int | Unset = 10,
    threshold_ms: float | Unset = 1000.0,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/analytics/performance/engine/slow-operations",
        "params": params,
    }
...
def sync_detailed(
    ...
    **Example:**
    ...
    Args:
        ...
        limit (int | Unset): Number of operations to return Default: 10.
        threshold_ms (float | Unset): Only show operations slower than this (ms) Default: 1000.0.
