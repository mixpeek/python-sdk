...
def _get_kwargs(
    *,
    body: ListTemplatesRequest | Unset = UNSET,
...
) -> ErrorResponse | HTTPValidationError | ListTemplatesResponse | None:
    if response.status_code == 200:
        response_200 = ListTemplatesResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | HTTPValidationError | ListTemplatesResponse]:
    return Response(
...
def sync_detailed(
    ...
    **Request Body (optional):**
    - `filters`: Attribute-based filters `{\"AND\": [{\"field\": \"category\", \"operator\": \"eq\",
    ...
    Args:
        ...
        body (ListTemplatesRequest | Unset): Request model for listing templates.
...
def sync(
    ...
    **Request Body (optional):**
    ...
    Returns:
        ErrorResponse | HTTPValidationError | ListTemplatesResponse
    """
