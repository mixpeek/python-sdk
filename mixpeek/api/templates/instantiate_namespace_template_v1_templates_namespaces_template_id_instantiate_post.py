...
from ...models.instantiate_template_request import InstantiateTemplateRequest
from ...models.instantiated_template_response import InstantiatedTemplateResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/templates/namespaces/{template_id}/instantiate".format(
...
) -> ErrorResponse | HTTPValidationError | InstantiatedTemplateResponse | None:
    if response.status_code == 201:
        response_201 = InstantiatedTemplateResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | HTTPValidationError | InstantiatedTemplateResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (InstantiateTemplateRequest): Request to create a new namespace from a template.
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | HTTPValidationError | InstantiatedTemplateResponse
    """
