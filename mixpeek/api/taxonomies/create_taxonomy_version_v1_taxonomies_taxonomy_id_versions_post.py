...
from ...models.create_taxonomy_version_v1_taxonomies_taxonomy_id_versions_post_body import (
...
def _get_kwargs(
    taxonomy_id: str,
    *,
    body: CreateTaxonomyVersionV1TaxonomiesTaxonomyIdVersionsPostBody,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/taxonomies/{taxonomy_id}/versions".format(
