...
from ...models.list_taxonomies_request import ListTaxonomiesRequest
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: ListTaxonomiesRequest | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (ListTaxonomiesRequest | Unset): Request model to list taxonomies.
