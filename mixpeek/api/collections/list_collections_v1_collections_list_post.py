...
from ...models.list_collections_request import ListCollectionsRequest
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: ListCollectionsRequest | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (ListCollectionsRequest | Unset): Request model for listing collections.

            To filter by taxonomy, use dot notation in filters:
            filters.AND = [{"field": "taxonomy_applications.taxonomy_id", "operator": "eq", "value":
            "tax_123"}]
