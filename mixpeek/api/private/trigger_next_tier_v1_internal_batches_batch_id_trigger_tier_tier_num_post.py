...
from ...models.trigger_tier_request import TriggerTierRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/internal/batches/{batch_id}/trigger-tier/{tier_num}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (TriggerTierRequest): Request to trigger next tier processing.
