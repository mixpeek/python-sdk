...
from ...models.list_clusters_request import ListClustersRequest
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: ListClustersRequest | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (ListClustersRequest | Unset): Request model for listing clusters.
