...
if TYPE_CHECKING:
    ...
    from ..models.document_aggregation_request_filters_type_0 import DocumentAggregationRequestFiltersType0
...
T = TypeVar("T", bound="DocumentAggregationRequest")


@_attrs_define
class DocumentAggregationRequest:
    """Aggregation request for collection documents.
    ...
    Examples:
        ...
        Attributes:
            ...
            filters (DocumentAggregationRequestFiltersType0 | None | Unset): Pre-aggregation filters to apply to source
                data. OPTIONAL, filters data before grouping. Uses same syntax as standard query filters. Applied before GROUP
                BY.
    ...
    filters: DocumentAggregationRequestFiltersType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.filters, Unset):
            filters = UNSET
        elif isinstance(self.filters, DocumentAggregationRequestFiltersType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_filters(data: object) -> DocumentAggregationRequestFiltersType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                filters_type_0 = DocumentAggregationRequestFiltersType0.from_dict(data)

                return filters_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DocumentAggregationRequestFiltersType0 | None | Unset, data)
        ...
        document_aggregation_request = cls(
            group_by=group_by,
            aggregations=aggregations,
            filters=filters,
            having=having,
        ...
        document_aggregation_request.additional_properties = d
        return document_aggregation_request
