...
from ...models.list_adhoc_executions_request import ListAdhocExecutionsRequest
from ...models.list_adhoc_executions_response import ListAdhocExecutionsResponse
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: ListAdhocExecutionsRequest | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/retrievers/executions/list",
        "params": params,
    }
...
) -> ErrorResponse | HTTPValidationError | ListAdhocExecutionsResponse | None:
    if response.status_code == 200:
        response_200 = ListAdhocExecutionsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | HTTPValidationError | ListAdhocExecutionsResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (ListAdhocExecutionsRequest | Unset): Request to list ad-hoc retriever executions
            with filtering.
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | HTTPValidationError | ListAdhocExecutionsResponse
    """
