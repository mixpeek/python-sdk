...
from ...models.list_sync_configurations_request import ListSyncConfigurationsRequest
...
def _get_kwargs(
    bucket_id: str,
    *,
    body: ListSyncConfigurationsRequest | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/buckets/{bucket_id}/syncs/list".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ListSyncConfigurationsRequest | Unset): Request to filter sync configurations for
            listing.
