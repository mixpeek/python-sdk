...
from ...models.patch_cluster_request import PatchClusterRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/clusters/{cluster_identifier}".format(
            cluster_identifier=quote(str(cluster_identifier), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (PatchClusterRequest): Request model for partially updating a cluster (PATCH
            operation).
