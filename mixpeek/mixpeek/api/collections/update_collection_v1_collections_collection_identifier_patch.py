...
from ...models.update_collection_v1_collections_collection_identifier_patch_updates import (
...
def _get_kwargs(
    ...
    *,
    body: UpdateCollectionV1CollectionsCollectionIdentifierPatchUpdates,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/collections/{collection_identifier}".format(
