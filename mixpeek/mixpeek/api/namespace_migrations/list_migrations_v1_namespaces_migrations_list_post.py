...
from ...models.list_migrations_request import ListMigrationsRequest
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: ListMigrationsRequest,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/namespaces/migrations/list",
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (ListMigrationsRequest): Request to list migrations with filters.
