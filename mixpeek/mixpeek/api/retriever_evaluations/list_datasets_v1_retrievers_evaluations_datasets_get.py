...
) -> DatasetListResponse | ErrorResponse | HTTPValidationError | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DatasetListResponse | ErrorResponse | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        DatasetListResponse | ErrorResponse | HTTPValidationError
    """
