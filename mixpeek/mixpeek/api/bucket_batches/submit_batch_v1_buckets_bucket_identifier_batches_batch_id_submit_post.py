...
from ...models.submit_batch_request import SubmitBatchRequest
...
def _get_kwargs(
    ...
    batch_id: str,
    *,
    body: SubmitBatchRequest | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/buckets/{bucket_identifier}/batches/{batch_id}/submit".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Submit Batch for Processing
     ...
     Submit a batch for asynchronous processing. The batch must be in 'pending' status and contain
    objects.
    ...
    Args:
        ...
        body (SubmitBatchRequest | Unset): Request model for submitting a batch for processing.
            ...
            Use Cases:
                ...
                - Submit batch without processing history for cleaner metadata
