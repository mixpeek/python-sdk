...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/buckets/{bucket_identifier}/batches/{batch_id}/logs".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Ray Job Logs for Batch
     ...
     Retrieve Ray job submission logs for a batch's processing tiers. You can get logs for a specific
    tier or all tiers. User must have access to the batch to retrieve logs.

    Args:
        bucket_identifier (str): The unique identifier of the bucket.
        batch_id (str): The unique identifier of the batch.
        tier_num (int | None | Unset): Optional tier number (0-based). If not provided, returns
            logs for all tiers.
