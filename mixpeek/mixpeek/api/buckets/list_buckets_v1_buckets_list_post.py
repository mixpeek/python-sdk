...
from ...models.list_buckets_request import ListBucketsRequest
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: ListBucketsRequest | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (ListBucketsRequest | Unset): Request model for listing buckets.
