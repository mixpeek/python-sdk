...
) -> ErrorResponse | HTTPValidationError | TerminateSessionResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | HTTPValidationError | TerminateSessionResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | HTTPValidationError | TerminateSessionResponse
     """
