...
from ...models.bucket_storage_response import BucketStorageResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/analytics/buckets/{bucket_id}/storage".format(
...
) -> BucketStorageResponse | ErrorResponse | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = BucketStorageResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[BucketStorageResponse | ErrorResponse | HTTPValidationError]:
    return Response(
...
def sync_detailed(
    ...
    **Example:**
    ...
    Args:
        ...
        group_by (str | Unset): Time grouping: hour, day, week, month Default: 'day'.
...
def sync(
    ...
    **Example:**
    ...
    Returns:
        BucketStorageResponse | ErrorResponse | HTTPValidationError
     """
