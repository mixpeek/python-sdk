...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/analytics/performance/engine",
        "params": params,
    }
...
def sync_detailed(
    ...
    **Example:**
    ...
    Args:
        hours (int | None | Unset): Hours of history (alternative to date range)
        start_date (datetime.datetime | None | Unset): Start date for time range
        end_date (datetime.datetime | None | Unset): End date for time range
        group_by (str | Unset): Time grouping (minute, hour, day, week) Default: 'hour'.
