...
from ...models.bucket_usage_response import BucketUsageResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/analytics/buckets/{bucket_id}/usage".format(
...
) -> BucketUsageResponse | ErrorResponse | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = BucketUsageResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[BucketUsageResponse | ErrorResponse | HTTPValidationError]:
    return Response(
...
def sync(
    ...
    **Example:**
    ...
    Returns:
        BucketUsageResponse | ErrorResponse | HTTPValidationError
     """
