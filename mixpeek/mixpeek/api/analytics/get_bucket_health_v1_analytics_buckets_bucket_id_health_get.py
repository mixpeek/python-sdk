...
from ...models.bucket_health_response import BucketHealthResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/analytics/buckets/{bucket_id}/health".format(
...
) -> BucketHealthResponse | ErrorResponse | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = BucketHealthResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[BucketHealthResponse | ErrorResponse | HTTPValidationError]:
    return Response(
...
def sync(
    ...
    **Example:**
    ...
    Returns:
        BucketHealthResponse | ErrorResponse | HTTPValidationError
     """
