...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/clusters/{cluster_id}/executions/{run_id}".format(
...
) -> ClusterExecutionResult | ErrorResponse | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = ClusterExecutionResult.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClusterExecutionResult | ErrorResponse | HTTPValidationError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ClusterExecutionResult | ErrorResponse | HTTPValidationError
    """
