...
class GrowthMetric(BaseModel):
    ...
    documents_added: StrictInt
    success_rate: Union[StrictFloat, StrictInt]
    avg_latency_ms: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["time_bucket", "documents_added", "success_rate", "avg_latency_ms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "documents_added": obj.get("documents_added"),
