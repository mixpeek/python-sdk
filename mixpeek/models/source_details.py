...
class SourceDetails(BaseModel):
    ...
    """ # noqa: E501
    type: SourceType = Field(description="Immediate origin type from which this entity was derived.")
    source_id: StrictStr = Field(description="Identifier of the immediate source entity (e.g., bucket_id, collection_id, taxonomy_id).")
    __properties: ClassVar[List[str]] = ["type", "source_id"]
