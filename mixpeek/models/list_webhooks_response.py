...
class ListWebhooksResponse(BaseModel):
    ...
    """ # noqa: E501
    results: List[WebhookOutput] = Field(description="List of webhooks")
    pagination: PaginationResponse = Field(description="Pagination information")
    total: StrictInt = Field(description="Total number of webhooks")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [WebhookOutput.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
