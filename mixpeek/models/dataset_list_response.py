...
class DatasetListResponse(BaseModel):
    ...
    """ # noqa: E501
    datasets: List[EvaluationDataset] = Field(description="List of datasets")
    total: StrictInt = Field(description="Total number of datasets")
    page: StrictInt = Field(description="Current page number")
    page_size: StrictInt = Field(description="Items per page")
    __properties: ClassVar[List[str]] = ["datasets", "total", "page", "page_size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "datasets": [EvaluationDataset.from_dict(_item) for _item in obj["datasets"]] if obj.get("datasets") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
