...
class EvaluationListResponse(BaseModel):
    ...
    """ # noqa: E501
    evaluations: List[EvaluationRecord] = Field(description="List of evaluations")
    total: StrictInt = Field(description="Total count")
    page: StrictInt = Field(description="Current page")
    page_size: StrictInt = Field(description="Page size")
    __properties: ClassVar[List[str]] = ["evaluations", "total", "page", "page_size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "evaluations": [EvaluationRecord.from_dict(_item) for _item in obj["evaluations"]] if obj.get("evaluations") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
