...
class ExecutionHistoryResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cluster_id", "time_range", "results", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [ClusterExecutionMetric.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
