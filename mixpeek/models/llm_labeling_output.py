...
class LLMLabelingOutput(BaseModel):
    ...
    embedding_similarity_threshold: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0.5)], Annotated[int, Field(le=1, strict=True, ge=1)]]] = Field(default=0.8, description="Cosine similarity threshold for duplicate label detection (labels above this are considered duplicates)")
