...
class GrowthMetricsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["collection_id", "time_range", "metrics", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metrics": [GrowthMetric.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None,
