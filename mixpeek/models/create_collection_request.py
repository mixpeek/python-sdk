...
class CreateCollectionRequest(BaseModel):
    ...
    schedule: Optional[CollectionScheduleConfig] = Field(default=None, description="Optional schedule for automatic re-processing. Creates a COLLECTION_TRIGGER trigger behind the scenes. Supports cron and interval schedules.")
    ...
    __properties: ClassVar[List[str]] = ["collection_name", "description", "source", "input_schema", "feature_extractor", "enabled", "metadata", "schedule", "taxonomy_applications", "cluster_applications", "alert_applications", "retriever_enrichments"]
