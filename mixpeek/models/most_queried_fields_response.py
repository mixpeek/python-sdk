...
class MostQueriedFieldsResponse(BaseModel):
    """
    ...
    fields: List[FieldQueryMetrics] = Field(description="Most queried fields")
    total_fields: StrictInt = Field(description="Total unique fields found")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fields": [FieldQueryMetrics.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,
