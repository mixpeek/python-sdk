...
class OrganizationModelResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["organization_id", "organization_name", "logo_url", "account_type", "credit_count", "metadata", "billing_email", "rate_limits", "auto_billing_enabled", "billing_cycle_start", "current_month_usage", "created_at", "updated_at", "users"]
