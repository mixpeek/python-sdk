...
class ListExecutionsRequest(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="Optional status filter (completed, failed, running).")
    __properties: ClassVar[List[str]] = ["filters", "sorts", "status"]
