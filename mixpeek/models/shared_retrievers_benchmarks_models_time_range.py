...
class SharedRetrieversBenchmarksModelsTimeRange(BaseModel):
    """
    Time range filter for session queries.
    """ # noqa: E501
    start: Optional[datetime] = Field(default=None, description="Start of time range (inclusive).")
    end: Optional[datetime] = Field(default=None, description="End of time range (inclusive).")
