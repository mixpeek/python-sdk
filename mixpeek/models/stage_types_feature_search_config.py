...
class StageTypesFeatureSearchConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["feature_uri", "query", "top_k", "min_score", "weight", "on_empty", "query_preprocessing", "collection_identifiers"]
