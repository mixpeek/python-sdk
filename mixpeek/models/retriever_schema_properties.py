...
T = TypeVar("T", bound="RetrieverSchemaProperties")


@_attrs_define
class RetrieverSchemaProperties:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        retriever_schema_properties = cls()
        ...
        retriever_schema_properties.additional_properties = additional_properties
        return retriever_schema_properties
