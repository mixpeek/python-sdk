...
class BatchConfirmRequest(BaseModel):
    ...
    """ # noqa: E501
    confirmations: Annotated[List[Dict[str, Any]], Field(min_length=1, max_length=100)] = Field(description="List of confirmations with upload_id, etag, file_size_bytes")
    __properties: ClassVar[List[str]] = ["confirmations"]
