...
class AlertExecutionListResponse(BaseModel):
    """
    Response model for listing alert executions.
    """ # noqa: E501
    results: List[AlertExecutionResult] = Field(description="List of execution results")
    pagination: PaginationResponse = Field(description="Pagination information")
    total_count: StrictInt = Field(description="Total number of executions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [AlertExecutionResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
