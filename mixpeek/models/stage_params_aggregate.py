...
class StageParamsAggregate(BaseModel):
    ...
    """ # noqa: E501
    aggregations: Optional[Annotated[List[StageDefsAggregationOperation], Field(min_length=1)]] = Field(default=None, description="List of aggregation operations to compute. At least one aggregation is required. Multiple aggregations can be computed in a single stage.")
