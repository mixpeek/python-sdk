...
class StructuredDataConfig(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='WebApplication', description="Schema.org type for structured data")
    additional_properties: Optional[Dict[str, Any]] = Field(default=None, description="Additional Schema.org properties")
    __properties: ClassVar[List[str]] = ["type", "additional_properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'WebApplication',
