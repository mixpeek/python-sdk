...
class ListDocumentsRequest(BaseModel):
    ...
    limit: Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]] = Field(default=10, description="Number of documents to return per page.")
    ...
    __properties: ClassVar[List[str]] = ["filters", "sort", "search", "cursor", "return_presigned_urls", "return_vectors", "return_vector_names", "group_by", "select", "limit", "offset"]
