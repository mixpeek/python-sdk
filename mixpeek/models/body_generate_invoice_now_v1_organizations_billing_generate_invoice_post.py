...
class BodyGenerateInvoiceNowV1OrganizationsBillingGenerateInvoicePost(BaseModel):
    """
    BodyGenerateInvoiceNowV1OrganizationsBillingGenerateInvoicePost
    """ # noqa: E501
    billing_month: Optional[StrictStr] = Field(default=None, description="Billing month (YYYY-MM). Defaults to previous month.")
    dry_run: Optional[StrictBool] = Field(default=False, description="If true, show what would be invoiced without creating Stripe invoice.")
    __properties: ClassVar[List[str]] = ["billing_month", "dry_run"]
