...
class RetrieverModelOutput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["retriever_id", "retriever_name", "description", "collection_ids", "stages", "input_schema", "budget_limits", "feature_dependencies", "tags", "display_config", "version", "created_at", "updated_at", "created_by", "updated_by", "is_published", "marketplace_listing_id"]
