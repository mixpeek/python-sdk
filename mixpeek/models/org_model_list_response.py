...
class OrgModelListResponse(BaseModel):
    """
    Response model for listing org models.
    """ # noqa: E501
    success: Optional[StrictBool] = True
    models: List[OrgModelListItem]
    total: StrictInt
    organization_id: StrictStr
    __properties: ClassVar[List[str]] = ["success", "models", "total", "organization_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "models": [OrgModelListItem.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None,
            "total": obj.get("total"),
