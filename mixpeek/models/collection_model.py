...
class CollectionModel(BaseModel):
    ...
    document_count: Optional[StrictInt] = Field(default=0, description="Number of documents currently in the collection. Automatically maintained by the system as documents are added or removed. Used for: Sorting, filtering, and pagination in list endpoints. Updated during batch processing and document operations.")
    ...
    __properties: ClassVar[List[str]] = ["collection_id", "collection_name", "description", "input_schema", "output_schema", "feature_extractor", "source", "source_bucket_schemas", "source_lineage", "vector_indexes", "payload_indexes", "enabled", "metadata", "schedule", "trigger_id", "created_at", "updated_at", "lifecycle_state", "s3_vector_index", "last_lifecycle_transition", "tiering_rules", "document_count", "schema_version", "last_schema_sync", "schema_sync_enabled", "taxonomy_applications", "cluster_applications", "alert_applications", "retriever_enrichments"]
