...
RESPONSESHAPE2_ANY_OF_SCHEMAS = ["Dict[str, object]", "str"]

class ResponseShape2(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ResponseShape2.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ResponseShape2 with anyOf schemas: Dict[str, object], str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ResponseShape2 with anyOf schemas: Dict[str, object], str. Details: " + ", ".join(error_messages))
        else:
            return instance
