...
class TieringRule(BaseModel):
    ...
    threshold_days: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["rule_type", "enabled", "threshold_days"]

    @field_validator('rule_type')
    def rule_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['auto_evict', 'auto_archive', 'auto_rehydrate']):
            raise ValueError("must be one of enum values ('auto_evict', 'auto_archive', 'auto_rehydrate')")
        return value
