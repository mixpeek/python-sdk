...
class BucketSchemaFieldOutput(BaseModel):
    ...
    items: Optional[BucketSchemaFieldOutput] = None
    properties: Optional[Dict[str, BucketSchemaFieldOutput]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": BucketSchemaFieldOutput.from_dict(obj["items"]) if obj.get("items") is not None else None,
            "properties": dict(
...
BucketSchemaFieldOutput.model_rebuild(raise_errors=False)
