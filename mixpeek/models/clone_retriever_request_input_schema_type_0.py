...
T = TypeVar("T", bound="CloneRetrieverRequestInputSchemaType0")


@_attrs_define
class CloneRetrieverRequestInputSchemaType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        clone_retriever_request_input_schema_type_0 = cls()
        ...
        clone_retriever_request_input_schema_type_0.additional_properties = additional_properties
        return clone_retriever_request_input_schema_type_0
