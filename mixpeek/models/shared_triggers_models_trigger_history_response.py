...
class SharedTriggersModelsTriggerHistoryResponse(BaseModel):
    """
    Response for trigger execution history.
    """ # noqa: E501
    trigger_id: StrictStr = Field(description="Trigger ID")
    executions: List[TriggerExecutionHistory] = Field(description="Execution history")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "executions": [TriggerExecutionHistory.from_dict(_item) for _item in obj["executions"]] if obj.get("executions") is not None else None,
            "total": obj.get("total"),
