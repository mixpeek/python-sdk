...
class SlowOperation(BaseModel):
    ...
    latency_ms: Union[StrictFloat, StrictInt] = Field(description="Operation latency")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Additional context from profiling")
    __properties: ClassVar[List[str]] = ["timestamp", "stage_name", "component", "latency_ms", "metadata"]
