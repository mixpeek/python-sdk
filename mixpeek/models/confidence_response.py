...
class ConfidenceResponse(BaseModel):
    ...
    avg_confidence: Union[StrictFloat, StrictInt]
    low_confidence_count: StrictInt = Field(description="Count of assignments below 0.5 confidence")
    __properties: ClassVar[List[str]] = ["taxonomy_id", "distribution", "avg_confidence", "low_confidence_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "distribution": [ConfidenceDistribution.from_dict(_item) for _item in obj["distribution"]] if obj.get("distribution") is not None else None,
            "avg_confidence": obj.get("avg_confidence"),
            "low_confidence_count": obj.get("low_confidence_count")
        })
        return _obj
