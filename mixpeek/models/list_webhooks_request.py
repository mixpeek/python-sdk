...
class ListWebhooksRequest(BaseModel):
    ...
    """ # noqa: E501
    event_type: Optional[StrictStr] = Field(default=None, description="Filter by event type")
    is_active: Optional[StrictBool] = Field(default=None, description="Filter by active status")
    __properties: ClassVar[List[str]] = ["event_type", "is_active"]
