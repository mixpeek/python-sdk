...
class DisableOrgModelResponse(BaseModel):
    """
    ...
    namespace_id: StrictStr = Field(description="Namespace where model was disabled")
    message: StrictStr = Field(description="Status message")
    __properties: ClassVar[List[str]] = ["success", "model_id", "namespace_id", "message"]
