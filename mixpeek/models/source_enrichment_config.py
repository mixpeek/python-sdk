...
class SourceEnrichmentConfig(BaseModel):
    ...
    """ # noqa: E501
    field_mappings: Optional[List[EnrichmentFieldMapping]] = Field(default=None, description="List of field mappings from cluster results to document fields. Default includes cluster_id and cluster_label. Can include: distance_to_centroid, member_count, keywords, visualization coords (x, y, z), etc.")
    __properties: ClassVar[List[str]] = ["field_mappings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "field_mappings": [EnrichmentFieldMapping.from_dict(_item) for _item in obj["field_mappings"]] if obj.get("field_mappings") is not None else None
        })
        return _obj
