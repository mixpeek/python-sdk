...
class RevisionHistoryEntry(BaseModel):
    ...
    updated_by: Optional[StrictStr] = Field(default=None, description="User who made the change")
    changes: Optional[StrictStr] = Field(default=None, description="Description of changes made")
    __properties: ClassVar[List[str]] = ["version", "updated_at", "updated_by", "changes"]
