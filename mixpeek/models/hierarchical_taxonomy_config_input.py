...
class HierarchicalTaxonomyConfigInput(BaseModel):
    """
    ...
    hierarchical_nodes: Optional[List[HierarchicalNodeInput]] = Field(default=None, description="Explicit node definitions that either: 1) Define the entire hierarchy (when inference_strategy is None), 2) Add additional nodes to an inferred hierarchy, or 3) Override specific relationships in an inferred hierarchy. Supports true hybrid: infer from some collections, manually add others.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hierarchical_nodes": [HierarchicalNodeInput.from_dict(_item) for _item in obj["hierarchical_nodes"]] if obj.get("hierarchical_nodes") is not None else None
        })
        return _obj
