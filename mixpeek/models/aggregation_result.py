...
class AggregationResult(BaseModel):
    ...
    """ # noqa: E501
    group: Dict[str, Any] = Field(description="Grouped field values that define this result row.")
    metrics: Dict[str, Any] = Field(description="Computed aggregation values for this group.")
    __properties: ClassVar[List[str]] = ["group", "metrics"]
