...
class SharedClustersTriggersModelsUpdateTriggerRequest(BaseModel):
    """
    ...
    status: Optional[SharedClustersTriggersModelsTriggerStatus] = Field(default=None, description="Updated status")
