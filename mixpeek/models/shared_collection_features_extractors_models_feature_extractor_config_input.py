...
class SharedCollectionFeaturesExtractorsModelsFeatureExtractorConfigInput(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["feature_extractor_name", "version", "params", "parameters", "input_mappings", "field_passthrough", "include_all_source_fields"]
