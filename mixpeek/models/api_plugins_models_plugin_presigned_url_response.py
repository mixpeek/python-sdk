...
class ApiPluginsModelsPluginPresignedURLResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["upload_id", "presigned_url", "s3_key", "expires_at", "organization_id", "name", "version"]
