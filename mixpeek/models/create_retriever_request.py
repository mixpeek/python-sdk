...
class CreateRetrieverRequest(BaseModel):
    ...
    visibility: Optional[RetrieverVisibility] = Field(default=None, description="Visibility level: PRIVATE (owner only), PUBLIC (any valid API key), MARKETPLACE (requires subscription). Defaults to PRIVATE.")
    marketplace_listing_id: Optional[StrictStr] = Field(default=None, description="Associated marketplace listing ID when visibility is MARKETPLACE (OPTIONAL).")
    ...
    __properties: ClassVar[List[str]] = ["retriever_name", "description", "visibility", "marketplace_listing_id", "requires_subscription", "collection_identifiers", "stages", "input_schema", "budget_limits", "tags", "display_config"]
