...
class ExtractorMetrics(BaseModel):
    ...
    p95_latency_ms: Union[StrictFloat, StrictInt]
    p99_latency_ms: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["extractor_name", "version", "execution_count", "success_count", "failure_count", "success_rate", "avg_latency_ms", "p95_latency_ms", "p99_latency_ms"]
