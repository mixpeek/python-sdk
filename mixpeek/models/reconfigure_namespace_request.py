...
class ReconfigureNamespaceRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    confirm: StrictBool = Field(description="Must be True to confirm this destructive operation. Existing Qdrant data will be deleted and must be re-ingested.")
