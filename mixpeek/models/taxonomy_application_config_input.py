...
class TaxonomyApplicationConfigInput(BaseModel):
    """
    ...
    scroll_filters: Optional[LogicalOperatorInput] = Field(default=None, description="Additional filters applied when scrolling the source collection before enrichment.")
