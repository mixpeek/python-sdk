...
class PatchTaxonomyRequest(BaseModel):
    ...
    """ # noqa: E501
    taxonomy_name: Optional[StrictStr] = Field(default=None, description="Updated name for the taxonomy")
    description: Optional[StrictStr] = Field(default=None, description="Updated description for the taxonomy")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Updated metadata for the taxonomy")
    __properties: ClassVar[List[str]] = ["taxonomy_name", "description", "metadata"]
