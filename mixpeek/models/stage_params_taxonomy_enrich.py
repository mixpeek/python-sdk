...
class StageParamsTaxonomyEnrich(BaseModel):
    ...
    fields: Optional[List[StageDefsEnrichmentField]] = Field(default=None, description="Fields from the taxonomy node to merge into the document.")
    ...
    min_score: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=0, description="Minimum similarity score required to keep an assignment.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fields": [StageDefsEnrichmentField.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,
            "top_k": obj.get("top_k") if obj.get("top_k") is not None else 3,
            "min_score": obj.get("min_score") if obj.get("min_score") is not None else 0,
