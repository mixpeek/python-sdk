...
class CreatePageRequest(BaseModel):
    ...
    """ # noqa: E501
    slug: Annotated[str, Field(min_length=3, strict=True, max_length=60)] = Field(description="URL-safe slug (globally unique, lowercase + hyphens)")
    template: Optional[StrictStr] = 'generic'
    ...
    __properties: ClassVar[List[str]] = ["slug", "template", "sections", "custom_html", "meta", "hero", "theme", "seo", "stats", "featured_gallery", "tabs", "password_secret_name", "is_active"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "slug": obj.get("slug"),
            "template": obj.get("template") if obj.get("template") is not None else 'generic',
