...
class SetupPaymentMethodResponse(BaseModel):
    ...
    """ # noqa: E501
    setup_intent_id: StrictStr = Field(description="Stripe SetupIntent ID")
    client_secret: StrictStr = Field(description="Client secret for Stripe Elements")
    customer_id: StrictStr = Field(description="Stripe Customer ID")
    __properties: ClassVar[List[str]] = ["setup_intent_id", "client_secret", "customer_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "setup_intent_id": obj.get("setup_intent_id"),
