...
T = TypeVar("T", bound="RetrieverInputSchemaFieldPropertiesType0")


@_attrs_define
class RetrieverInputSchemaFieldPropertiesType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        retriever_input_schema_field_properties_type_0 = cls()
        ...
        retriever_input_schema_field_properties_type_0.additional_properties = additional_properties
        return retriever_input_schema_field_properties_type_0
