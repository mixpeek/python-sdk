...
class SyncComparisonResponse(BaseModel):
    """
    ...
    configs: List[SyncConfigMetric] = Field(description="Metrics per sync config")
    __properties: ClassVar[List[str]] = ["bucket_id", "time_range", "configs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "configs": [SyncConfigMetric.from_dict(_item) for _item in obj["configs"]] if obj.get("configs") is not None else None
        })
        return _obj
