...
class StageDefsContentQueryInput(BaseModel):
    """
    ...
    content: Optional[StageDefsContentInput] = Field(default=None, description="Legacy content input (DEPRECATED - use 'value' instead). Provide URL or base64 separately via ContentInput model.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": StageDefsContentInput.from_dict(obj["content"]) if obj.get("content") is not None else None
        })
        return _obj
