...
class ListAdhocExecutionsResponse(BaseModel):
    """
    Response from listing ad-hoc retriever executions.
    """ # noqa: E501
    results: Optional[List[AdhocExecutionSummary]] = Field(default=None, description="List of ad-hoc execution summaries.")
    total: Optional[StrictInt] = Field(default=0, description="Total number of ad-hoc executions matching filters.")
    pagination: Optional[Any]
    __properties: ClassVar[List[str]] = ["results", "total", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [AdhocExecutionSummary.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
