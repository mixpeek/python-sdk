...
class SearchInteraction(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["feature_id", "interaction_type", "position", "metadata", "user_id", "session_id", "execution_id", "retriever_id", "query_snapshot", "document_score", "result_set_size"]
