...
class RetrieverInputSchemaFieldInput(BaseModel):
    """
    ...
    items: Optional[RetrieverInputSchemaFieldInput] = None
    properties: Optional[Dict[str, RetrieverInputSchemaFieldInput]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": RetrieverInputSchemaFieldInput.from_dict(obj["items"]) if obj.get("items") is not None else None,
            "properties": dict(
...
RetrieverInputSchemaFieldInput.model_rebuild(raise_errors=False)
