...
class GroupByOption(BaseModel):
    ...
    """ # noqa: E501
    var_field: StrictStr = Field(description="The field to group by.", alias="field")
    max_features: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=10, description="The maximum number of features (documents) to return per group.")
    sort: Optional[SortOption] = Field(default=None, description="Optional sorting options to apply within each group.")
    __properties: ClassVar[List[str]] = ["field", "max_features", "sort"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "field": obj.get("field"),
            "max_features": obj.get("max_features") if obj.get("max_features") is not None else 10,
