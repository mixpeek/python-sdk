...
class EngineStageBreakdownResponse(BaseModel):
    """
    Response for engine stage breakdown.
    """ # noqa: E501
    time_range: ApiAnalyticsModelsTimeRange = Field(description="Time range of the analysis")
    stages: List[StagePerformanceOutput] = Field(description="Performance breakdown by stage")
    total_time_ms: Union[StrictFloat, StrictInt] = Field(description="Total time across all stages (sum)")
    __properties: ClassVar[List[str]] = ["time_range", "stages", "total_time_ms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stages": [StagePerformanceOutput.from_dict(_item) for _item in obj["stages"]] if obj.get("stages") is not None else None,
