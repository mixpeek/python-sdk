...
class SortOption(BaseModel):
    ...
    """ # noqa: E501
    var_field: StrictStr = Field(description="Field to sort by, supports dot notation for nested fields", alias="field")
    direction: Optional[SortDirection] = Field(default=None, description="Sort direction")
