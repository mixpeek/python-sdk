...
class ListObjectsRequest(BaseModel):
    ...
    """ # noqa: E501
    filters: Optional[LogicalOperatorInput] = Field(default=None, description="Filters to apply to the object list")
    sort: Optional[SortOption] = Field(default=None, description="Sort options for the object list")
    search: Optional[StrictStr] = Field(default=None, description="Search term to filter objects by key or metadata")
    ...
    __properties: ClassVar[List[str]] = ["filters", "sort", "search", "select"]
