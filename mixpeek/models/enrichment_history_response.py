...
class EnrichmentHistoryResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["taxonomy_id", "time_range", "metrics", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "time_range": ApiAnalyticsTaxonomiesModelsTimeRange.from_dict(obj["time_range"]) if obj.get("time_range") is not None else None,
            "metrics": [EnrichmentMetric.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None,
