...
class RSSFieldSource(BaseModel):
    """
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='rss_field', description="Source type identifier.")
    var_field: StrictStr = Field(description="RSS entry field: title, author, link, categories, summary, published", alias="field")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['rss_field']):
            raise ValueError("must be one of enum values ('rss_field')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'rss_field',
            "field": obj.get("field")
        })
        return _obj
