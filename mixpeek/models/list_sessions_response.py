...
class ListSessionsResponse(BaseModel):
    ...
    """ # noqa: E501
    results: List[GetSessionResponse] = Field(description="Session list")
    total: StrictInt = Field(description="Total matching sessions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [GetSessionResponse.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "total": obj.get("total"),
