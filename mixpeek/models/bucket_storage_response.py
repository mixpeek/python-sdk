...
class BucketStorageResponse(BaseModel):
    ...
    metrics: List[StorageMetric] = Field(description="Time-series storage metrics")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metrics": [StorageMetric.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None,
