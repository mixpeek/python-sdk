...
class BucketSchemaFieldInput(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": BucketSchemaFieldInput.from_dict(obj["items"]) if obj.get("items") is not None else None,
            "properties": dict(
                (_k, BucketSchemaFieldInput.from_dict(_v))
...
BucketSchemaFieldInput.model_rebuild(raise_errors=False)
