...
class EnableOrgModelResponse(BaseModel):
    """
    ...
    namespace_id: StrictStr = Field(description="Namespace where model was enabled")
    deployment_status: StrictStr = Field(description="Deployment status (deployed, pending, skipped)")
    message: StrictStr = Field(description="Status message")
    __properties: ClassVar[List[str]] = ["success", "model_id", "namespace_id", "deployment_status", "message"]
