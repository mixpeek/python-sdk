...
class ListAlertsResponse(BaseModel):
    ...
    """ # noqa: E501
    results: List[AlertResponse] = Field(description="List of alerts")
    pagination: PaginationResponse = Field(description="Pagination information")
    total_count: StrictInt = Field(description="Total number of alerts matching query")
    stats: Optional[AlertListStats] = Field(default=None, description="Aggregate statistics across all alerts in the result")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [AlertResponse.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "pagination": PaginationResponse.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None,
            "total_count": obj.get("total_count"),
            "stats": AlertListStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None
        })
        return _obj
