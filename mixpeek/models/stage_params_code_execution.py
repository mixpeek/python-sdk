...
class StageParamsCodeExecution(BaseModel):
    ...
    on_error: Optional[StageDefsErrorHandling] = Field(default=None, description="'skip': On error, return input documents unchanged. 'raise': Fail entire pipeline on any error.")
