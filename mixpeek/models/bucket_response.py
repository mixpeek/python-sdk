...
class BucketResponse(BaseModel):
    ...
    stats_updated_at: Optional[datetime] = Field(default=None, description="When bucket stats were last successfully recalculated")
    ...
    __properties: ClassVar[List[str]] = ["bucket_id", "bucket_name", "description", "bucket_schema", "unique_key", "metadata", "object_count", "total_size_bytes", "created_at", "updated_at", "last_upload_at", "stats_updated_at", "status", "is_locked", "batch_stats", "storage_stats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stats_updated_at": obj.get("stats_updated_at"),
