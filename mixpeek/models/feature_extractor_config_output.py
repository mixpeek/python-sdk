...
class FeatureExtractorConfigOutput(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["feature_extractor_name", "version", "parameters", "input_mappings", "feature_extractor_id"]
