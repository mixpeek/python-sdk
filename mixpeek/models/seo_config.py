...
class SEOConfig(BaseModel):
    ...
    canonical_url: Optional[StrictStr] = Field(default=None, description="Canonical URL if different from default. Auto-set to https://mxp.co/r/{public_name} if not provided.")
