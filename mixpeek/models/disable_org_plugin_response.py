...
class DisableOrgPluginResponse(BaseModel):
    """
    Response from disabling an org-level plugin for a namespace.
    """ # noqa: E501
    success: StrictBool = Field(description="Whether the operation succeeded")
    plugin_id: StrictStr = Field(description="The plugin ID that was disabled")
    namespace_id: StrictStr = Field(description="The namespace where plugin was disabled")
    message: StrictStr = Field(description="Status message")
    __properties: ClassVar[List[str]] = ["success", "plugin_id", "namespace_id", "message"]
