...
class DescribeCollectionFeaturesResponse(BaseModel):
    """
    DescribeCollectionFeaturesResponse
    """ # noqa: E501
    features: List[CollectionFeatureDescriptor] = Field(description="Feature extractors and fields enabled on this collection")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "features": [CollectionFeatureDescriptor.from_dict(_item) for _item in obj["features"]] if obj.get("features") is not None else None
        })
        return _obj
