...
class NamespaceInfrastructure(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ray_cluster_id", "ray_head_node_url", "ray_dashboard_url", "qdrant_url", "qdrant_api_key", "qdrant_collection", "s3_vector_bucket", "compute_tier", "max_concurrent_jobs", "autoscaling_enabled", "min_workers", "max_workers", "gpu_type", "gpus_per_worker", "s3_plugin_bucket", "s3_plugin_prefix", "max_custom_plugins", "max_custom_models"]
