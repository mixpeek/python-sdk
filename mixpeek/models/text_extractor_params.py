...
class TextExtractorParams(BaseModel):
    ...
    """ # noqa: E501
    extractor_type: Optional[StrictStr] = Field(default='text_extractor', description="Discriminator field for parameter type identification. Must be 'text_extractor'.")
    ...
    __properties: ClassVar[List[str]] = ["extractor_type", "split_by", "chunk_size", "chunk_overlap", "response_shape", "llm_provider", "llm_model"]
