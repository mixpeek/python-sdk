...
class StageResponse(BaseModel):
    ...
    version: StrictStr
    execution_time: Union[StrictFloat, StrictInt]
    results: List[RetrieverResponseFinalResultsInner]
    metadata: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["stage_name", "version", "execution_time", "results", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [RetrieverResponseFinalResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
