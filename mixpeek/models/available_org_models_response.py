...
class AvailableOrgModelsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["success", "models", "total", "namespace_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "models": [AvailableOrgModelItem.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None,
            "total": obj.get("total"),
