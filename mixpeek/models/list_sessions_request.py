...
class ListSessionsRequest(BaseModel):
    ...
    """ # noqa: E501
    status: Optional[SessionStatus] = Field(default=None, description="Filter by session status")
    filters: Optional[Dict[str, Any]] = Field(default=None, description="Additional filters")
    sort: Optional[Dict[str, Any]] = Field(default=None, description="Sort configuration")
    __properties: ClassVar[List[str]] = ["status", "filters", "sort"]
