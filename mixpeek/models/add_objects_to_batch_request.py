...
class AddObjectsToBatchRequest(BaseModel):
    """
    The request model for adding objects to an existing batch.
    """ # noqa: E501
    object_ids: Annotated[List[StrictStr], Field(min_length=1)] = Field(description="A list of object IDs to add to the batch.")
