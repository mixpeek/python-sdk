...
class ErrorBreakdown(BaseModel):
    ...
    """ # noqa: E501
    error_type: StrictStr = Field(description="Error type")
    count: StrictInt = Field(description="Error count")
    percentage: Union[StrictFloat, StrictInt] = Field(description="Percentage of total errors")
    first_seen: datetime = Field(description="First occurrence")
    last_seen: datetime = Field(description="Last occurrence")
    __properties: ClassVar[List[str]] = ["error_type", "count", "percentage", "first_seen", "last_seen"]
