...
class PresignedURLModel(BaseModel):
    ...
    """ # noqa: E501
    key_name: StrictStr = Field(description="Logical name or filename, e.g., 'thumb.jpg'")
    object_key: StrictStr = Field(description="Full S3 object key")
    presigned_url: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Time-limited HTTPS URL")
    __properties: ClassVar[List[str]] = ["key_name", "object_key", "presigned_url"]
