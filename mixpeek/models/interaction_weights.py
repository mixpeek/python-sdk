...
class InteractionWeights(BaseModel):
    ...
    """ # noqa: E501
    weights: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = Field(default=None, description="Mapping of interaction_type -> weight (higher = more important).")
    __properties: ClassVar[List[str]] = ["weights"]
