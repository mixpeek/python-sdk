...
class MarkdownContent(BaseModel):
    ...
    """ # noqa: E501
    title: Annotated[str, Field(min_length=1, strict=True, max_length=200)] = Field(description="Title for the markdown content section")
    content: Annotated[str, Field(min_length=1, strict=True, max_length=50000)] = Field(description="Markdown-formatted content. Supports standard markdown syntax including headers, lists, links, images, code blocks, and emphasis. Limited to 50KB to prevent database issues.")
