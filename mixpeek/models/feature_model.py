...
class FeatureModel(BaseModel):
    ...
    """ # noqa: E501
    feature_extractor_id: StrictStr = Field(description="ID of the feature extractor that produced this response")
    payload: Optional[Dict[str, Any]] = Field(default=None, description="Metadata of the feature")
    vectors: Optional[Vectors] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["feature_extractor_id", "payload", "vectors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vectors": Vectors.from_dict(obj["vectors"]) if obj.get("vectors") is not None else None
        })
