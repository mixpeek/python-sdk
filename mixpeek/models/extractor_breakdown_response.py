...
class ExtractorBreakdownResponse(BaseModel):
    """
    ...
    extractors: List[ExtractorPerformance] = Field(description="Performance by extractor and stage")
    __properties: ClassVar[List[str]] = ["time_range", "extractors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "extractors": [ExtractorPerformance.from_dict(_item) for _item in obj["extractors"]] if obj.get("extractors") is not None else None
        })
        return _obj
