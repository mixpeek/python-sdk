...
class WebhookInput(BaseModel):
    ...
    internal_id: Optional[StrictStr] = Field(default=None, description="Organization internal identifier for multi-tenancy scoping. All webhook operations are scoped to this organization. Excluded from API responses for security. Format: int_{24-character secure token}.")
