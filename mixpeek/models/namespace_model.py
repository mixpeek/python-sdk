...
class NamespaceModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["namespace_id", "namespace_name", "namespace_type", "infrastructure", "cluster_id", "description", "feature_extractors", "payload_indexes", "document_count", "bucket_count", "collection_count", "object_count", "auto_create_indexes", "vector_inference_map", "created_at", "updated_at"]
