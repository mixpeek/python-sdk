...
class PublicPageSearchRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    tab_id: StrictStr = Field(description="Tab ID to search within")
    inputs: Optional[Dict[str, Any]] = Field(default=None, description="Search inputs")
    settings: Optional[Dict[str, Any]] = Field(default=None, description="Optional execution settings")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["tab_id", "inputs", "settings"]
