...
T = TypeVar("T", bound="ConfirmPaymentMethodRequest")
...
class ConfirmPaymentMethodRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        confirm_payment_method_request = cls(
            payment_method_id=payment_method_id,
        )

        confirm_payment_method_request.additional_properties = d
        return confirm_payment_method_request
