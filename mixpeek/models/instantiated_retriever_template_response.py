...
T = TypeVar("T", bound="InstantiatedRetrieverTemplateResponse")


@_attrs_define
class InstantiatedRetrieverTemplateResponse:
    ...
    Attributes:
        ...
        created_at (datetime.datetime | Unset): Timestamp when retriever was created
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        instantiated_retriever_template_response = cls(
            retriever_id=retriever_id,
            retriever_name=retriever_name,
            template_id=template_id,
            status=status,
        ...
        instantiated_retriever_template_response.additional_properties = d
        return instantiated_retriever_template_response
