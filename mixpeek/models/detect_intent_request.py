...
class DetectIntentRequest(BaseModel):
    ...
    """ # noqa: E501
    user_request: StrictStr = Field(description="User's natural language request")
    include_collection_analysis: Optional[StrictBool] = Field(default=True, description="Whether to check existing collections")
    __properties: ClassVar[List[str]] = ["user_request", "include_collection_analysis"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "include_collection_analysis": obj.get("include_collection_analysis") if obj.get("include_collection_analysis") is not None else True
        })
        return _obj
