...
class ExternalLink(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(description="Display name for the link")
    url: Annotated[str, Field(min_length=1, strict=True, max_length=2048)] = Field(description="URL to the external resource")
