...
class EnrichmentMetric(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["time_bucket", "enrichment_count", "success_count", "failure_count", "avg_latency_ms", "success_rate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enrichment_count": obj.get("enrichment_count"),
