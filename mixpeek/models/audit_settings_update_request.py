...
class AuditSettingsUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    read_auditing_enabled: Optional[StrictBool] = Field(default=None, description="Enable or disable read operation auditing.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "read_auditing_enabled": obj.get("read_auditing_enabled")
        })
        return _obj
