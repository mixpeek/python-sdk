...
class ClusterExecutionListStats(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "avg_execution_time_ms": obj.get("avg_execution_time_ms") if obj.get("avg_execution_time_ms") is not None else 0,
            "total_documents_clustered": obj.get("total_documents_clustered") if obj.get("total_documents_clustered") is not None else 0,
            "avg_num_clusters": obj.get("avg_num_clusters") if obj.get("avg_num_clusters") is not None else 0
        })
        return _obj
