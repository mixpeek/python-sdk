...
class CreateOrganizationRequest(BaseModel):
    ...
    auth_provider_org_id: Optional[StrictStr] = Field(default=None, description="External auth provider org ID to associate with this organization.")
    __properties: ClassVar[List[str]] = ["organization_name", "logo_url", "users", "metadata", "credit_count", "account_type", "auth_provider_org_id"]
