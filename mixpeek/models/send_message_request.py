...
class SendMessageRequest(BaseModel):
    ...
    """ # noqa: E501
    content: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Message text content (REQUIRED)")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Message metadata (OPTIONAL)")
    stream: Optional[StrictBool] = Field(default=True, description="Stream response as SSE (default: True)")
    __properties: ClassVar[List[str]] = ["content", "metadata", "stream"]
