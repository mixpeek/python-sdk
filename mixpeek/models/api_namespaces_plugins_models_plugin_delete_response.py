...
class ApiNamespacesPluginsModelsPluginDeleteResponse(BaseModel):
    """
    ...
    plugin_id: StrictStr
    message: StrictStr
    deployment_removed: Optional[StrictBool] = Field(default=False, description="True if a Ray Serve deployment was queued for removal via blue-green deployment")
    __properties: ClassVar[List[str]] = ["success", "plugin_id", "message", "deployment_removed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deployment_removed": obj.get("deployment_removed") if obj.get("deployment_removed") is not None else False
        })
        return _obj
