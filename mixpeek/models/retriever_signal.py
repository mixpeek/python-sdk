...
class RetrieverSignal(BaseModel):
    """
    Single retriever signal event.
    """ # noqa: E501
    timestamp: datetime = Field(description="Event timestamp")
    execution_id: StrictStr = Field(description="Execution identifier")
    signal_type: StrictStr = Field(description="Type of signal")
    signal_data: Dict[str, Any] = Field(description="Signal-specific data")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Additional metadata")
    __properties: ClassVar[List[str]] = ["timestamp", "execution_id", "signal_type", "signal_data", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "signal_data": obj.get("signal_data"),
