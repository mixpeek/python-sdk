...
class AgentConfig(BaseModel):
    ...
    """ # noqa: E501
    model: Optional[StrictStr] = Field(default='gemini-2.5-flash', description="LLM model identifier. Options: 'gemini-2.5-flash' (fastest, cheapest), 'gemini-2.5-pro' (better quality), 'gpt-4o-mini', 'gpt-4o'")
    temperature: Optional[Union[Annotated[float, Field(le=2, strict=True, ge=0)], Annotated[int, Field(le=2, strict=True, ge=0)]]] = Field(default=0.7, description="Sampling temperature for LLM responses (0.0-2.0). Lower values (0.0-0.3) are more deterministic. Higher values (0.8-2.0) are more creative.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "model": obj.get("model") if obj.get("model") is not None else 'gemini-2.5-flash',
