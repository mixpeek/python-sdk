...
class ListTriggersResponse(BaseModel):
    ...
    """ # noqa: E501
    triggers: List[TriggerModel] = Field(description="List of triggers")
    ...
    __properties: ClassVar[List[str]] = ["triggers", "total", "offset", "limit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "triggers": [TriggerModel.from_dict(_item) for _item in obj["triggers"]] if obj.get("triggers") is not None else None,
            "total": obj.get("total"),
