...
class BatchUploadResponse(BaseModel):
    ...
    """ # noqa: E501
    uploads: List[UploadResponse] = Field(description="Generated uploads with presigned URLs")
    total: StrictInt = Field(description="Total number of uploads created")
    __properties: ClassVar[List[str]] = ["uploads", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "uploads": [UploadResponse.from_dict(_item) for _item in obj["uploads"]] if obj.get("uploads") is not None else None,
            "total": obj.get("total")
        })
        return _obj
