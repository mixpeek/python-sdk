...
class StageParamsMmr(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "diversity_features": [StageDefsDiversityFeatureConfig.from_dict(_item) for _item in obj["diversity_features"]] if obj.get("diversity_features") is not None else None,
