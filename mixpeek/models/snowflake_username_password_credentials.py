...
class SnowflakeUsernamePasswordCredentials(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['username_password']):
            raise ValueError("must be one of enum values ('username_password')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'username_password',
