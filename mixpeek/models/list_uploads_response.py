...
class ListUploadsResponse(BaseModel):
    ...
    """ # noqa: E501
    results: List[UploadResponse] = Field(description="List of upload records matching the query")
    pagination: PaginationResponse = Field(description="Pagination metadata including total count, limit, offset, has_more")
    stats: UploadListStats = Field(description="Aggregate statistics across all uploads in the result")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stats": UploadListStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None
        })
        return _obj
