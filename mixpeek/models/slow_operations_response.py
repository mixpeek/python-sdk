...
class SlowOperationsResponse(BaseModel):
    ...
    operations: List[SlowOperation] = Field(description="List of slowest operations")
    threshold_ms: Union[StrictFloat, StrictInt] = Field(description="Latency threshold used for filtering")
    __properties: ClassVar[List[str]] = ["time_range", "operations", "threshold_ms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "operations": [SlowOperation.from_dict(_item) for _item in obj["operations"]] if obj.get("operations") is not None else None,
