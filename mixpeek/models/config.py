...
CONFIG_ONE_OF_SCHEMAS = ["FlatTaxonomyConfigInput", "HierarchicalTaxonomyConfigInput"]
...
class Config(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in Config with oneOf schemas: FlatTaxonomyConfigInput, HierarchicalTaxonomyConfigInput. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in Config with oneOf schemas: FlatTaxonomyConfigInput, HierarchicalTaxonomyConfigInput. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into Config with oneOf schemas: FlatTaxonomyConfigInput, HierarchicalTaxonomyConfigInput. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Config with oneOf schemas: FlatTaxonomyConfigInput, HierarchicalTaxonomyConfigInput. Details: " + ", ".join(error_messages))
        else:
            return instance
