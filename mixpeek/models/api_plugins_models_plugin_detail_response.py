...
class ApiPluginsModelsPluginDetailResponse(BaseModel):
    """
    Response model for plugin details.
    """ # noqa: E501
    success: Optional[StrictBool] = True
    plugin: ApiPluginsModelsPluginDocument
    __properties: ClassVar[List[str]] = ["success", "plugin"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "plugin": ApiPluginsModelsPluginDocument.from_dict(obj["plugin"]) if obj.get("plugin") is not None else None
        })
        return _obj
