...
class ListAlertsRequest(BaseModel):
    ...
    """ # noqa: E501
    search: Optional[StrictStr] = Field(default=None, description="Search term for wildcard search across alert_id, name, description")
    filters: Optional[LogicalOperatorInput] = Field(default=None, description="Filters to apply to the alert list")
    sort: Optional[SortOption] = Field(default=None, description="Sort configuration for the alert list")
