...
class StageParamsFeatureSearch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cache_behavior", "cache_ttl_seconds", "searches", "final_top_k", "fusion", "learning_config", "query_preprocessing", "collection_identifiers", "facets", "group_by"]
