...
class TaxonomyApplicationConfig(BaseModel):
    ...
    execution_mode: Optional[TaxonomyExecutionMode] = Field(default=None, description="'on_demand' executes at query time; 'materialize' materialises during ingestion.")
