...
class PublicInteractionBatchRequest(BaseModel):
    """
    Request to track multiple interactions in batch.
    """ # noqa: E501
    interactions: Annotated[List[PublicInteractionRequest], Field(min_length=1, max_length=100)] = Field(description="List of interactions to track (max 100 per batch)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "interactions": [PublicInteractionRequest.from_dict(_item) for _item in obj["interactions"]] if obj.get("interactions") is not None else None
        })
        return _obj
