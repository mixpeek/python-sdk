...
class PublicPageConfigResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["slug", "template", "sections", "custom_html", "meta", "hero", "theme", "seo", "stats", "featured_gallery", "tabs", "is_active", "password_protected"]
