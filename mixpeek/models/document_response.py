...
class DocumentResponse(BaseModel):
    ...
    vectors: Optional[List[StrictStr]] = Field(default=None, description="List of available named vectors for this document. Only present when return_vector_names=true. Contains sorted vector names stored in Qdrant (e.g., ['fashionsiglip_v1_embedding', 'text_extractor_v1_embedding']). Use individual names with return_vector_names=['name'] to fetch specific embeddings.", alias="_vectors")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["document_id", "collection_id", "document_blobs", "_internal", "_vectors"]
