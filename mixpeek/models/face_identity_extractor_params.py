...
class FaceIdentityExtractorParams(BaseModel):
    ...
    detection_threshold: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=0.5, description="Confidence threshold for face detection (0.0-1.0).")
    ...
    quality_threshold: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=None, description="Minimum quality score to index faces. None: Index all faces. 0.5: Moderate filtering. 0.7: High quality only.")
    ...
    video_sampling_fps: Optional[Union[Annotated[float, Field(le=60, strict=True, ge=0.1)], Annotated[int, Field(le=60, strict=True, ge=1)]]] = Field(default=1, description="Frames per second to sample from video. 1.0: One frame per second (recommended).")
    ...
    video_deduplication_threshold: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=0.8, description="Cosine similarity threshold for deduplication. 0.8: Conservative (default).")
    ...
    include_source_frame_thumbnail: Optional[StrictBool] = Field(default=False, description="Include resized source frame/image as base64 thumbnail (~15-30KB per face). Used for display with bounding box overlay.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "video_sampling_fps": obj.get("video_sampling_fps") if obj.get("video_sampling_fps") is not None else 1,
            ...
            "include_source_frame_thumbnail": obj.get("include_source_frame_thumbnail") if obj.get("include_source_frame_thumbnail") is not None else False,
