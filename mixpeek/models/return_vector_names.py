...
RETURNVECTORNAMES_ANY_OF_SCHEMAS = ["List[str]", "bool"]

class ReturnVectorNames(BaseModel):
    """
    ...
    any_of_schemas: Set[str] = { "List[str]", "bool" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ReturnVectorNames.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ReturnVectorNames with anyOf schemas: List[str], bool. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ReturnVectorNames with anyOf schemas: List[str], bool. Details: " + ", ".join(error_messages))
        else:
            return instance
