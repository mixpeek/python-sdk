...
class FilterCondition(BaseModel):
    ...
    operator: Optional[FilterOperator] = Field(default=None, description="Comparison operator")
    value: Optional[DynamicValue]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": DynamicValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
