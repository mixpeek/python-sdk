...
class StageDefsEnrichmentField(BaseModel):
    """
    ...
    merge_mode: Optional[StageDefsEnrichmentMergeMode] = Field(default=None, description="Whether to overwrite the target's value or append (for arrays).")
