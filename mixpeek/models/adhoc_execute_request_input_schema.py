...
T = TypeVar("T", bound="AdhocExecuteRequestInputSchema")


@_attrs_define
class AdhocExecuteRequestInputSchema:
    """REQUIRED. Input schema defining expected inputs. Each key is an input name, value is a RetrieverInputSchemaField."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        adhoc_execute_request_input_schema = cls()
        ...
        adhoc_execute_request_input_schema.additional_properties = additional_properties
        return adhoc_execute_request_input_schema
