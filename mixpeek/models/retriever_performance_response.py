...
class RetrieverPerformanceResponse(BaseModel):
    """
    Retriever performance metrics response.
    """ # noqa: E501
    retriever_id: StrictStr = Field(description="Retriever identifier")
    time_range: ApiAnalyticsModelsTimeRange = Field(description="Time range of the data")
    metrics: List[Dict[str, Any]] = Field(description="Time-series performance metrics")
    summary: Optional[Dict[str, Any]] = Field(default=None, description="Aggregated summary statistics")
    __properties: ClassVar[List[str]] = ["retriever_id", "time_range", "metrics", "summary"]
