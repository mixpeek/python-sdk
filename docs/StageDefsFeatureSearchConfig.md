...
stage_defs_feature_search_config_instance = StageDefsFeatureSearchConfig.from_json(json)
# print the JSON string representation of the object
print(StageDefsFeatureSearchConfig.to_json())

# convert the object into a dict
stage_defs_feature_search_config_dict = stage_defs_feature_search_config_instance.to_dict()
# create an instance of StageDefsFeatureSearchConfig from a dict
stage_defs_feature_search_config_from_dict = StageDefsFeatureSearchConfig.from_dict(stage_defs_feature_search_config_dict)
```
