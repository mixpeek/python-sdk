...
step_analytics_config_input_instance = StepAnalyticsConfigInput.from_json(json)
# print the JSON string representation of the object
print(StepAnalyticsConfigInput.to_json())

# convert the object into a dict
step_analytics_config_input_dict = step_analytics_config_input_instance.to_dict()
# create an instance of StepAnalyticsConfigInput from a dict
step_analytics_config_input_from_dict = StepAnalyticsConfigInput.from_dict(step_analytics_config_input_dict)
```
