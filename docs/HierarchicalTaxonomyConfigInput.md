...
json = "{}"
# create an instance of HierarchicalTaxonomyConfigInput from a JSON string
hierarchical_taxonomy_config_input_instance = HierarchicalTaxonomyConfigInput.from_json(json)
# print the JSON string representation of the object
print(HierarchicalTaxonomyConfigInput.to_json())

# convert the object into a dict
hierarchical_taxonomy_config_input_dict = hierarchical_taxonomy_config_input_instance.to_dict()
# create an instance of HierarchicalTaxonomyConfigInput from a dict
hierarchical_taxonomy_config_input_from_dict = HierarchicalTaxonomyConfigInput.from_dict(hierarchical_taxonomy_config_input_dict)
```
