...
content_query_input_instance = ContentQueryInput.from_json(json)
# print the JSON string representation of the object
print(ContentQueryInput.to_json())

# convert the object into a dict
content_query_input_dict = content_query_input_instance.to_dict()
# create an instance of ContentQueryInput from a dict
content_query_input_from_dict = ContentQueryInput.from_dict(content_query_input_dict)
```
