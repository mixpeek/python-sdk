...
json = "{}"
# create an instance of LogicalOperator4 from a JSON string
logical_operator4_instance = LogicalOperator4.from_json(json)
# print the JSON string representation of the object
print(LogicalOperator4.to_json())

# convert the object into a dict
logical_operator4_dict = logical_operator4_instance.to_dict()
# create an instance of LogicalOperator4 from a dict
logical_operator4_from_dict = LogicalOperator4.from_dict(logical_operator4_dict)
```
