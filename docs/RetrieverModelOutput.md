...
**input_schema** | [**RetrieverSchemaOutput**](RetrieverSchemaOutput.md) | Input schema for the retriever | 
**collection_ids** | **List[str]** | List of collection IDs | 
**stages** | [**List[StageInstanceConfigOutput]**](StageInstanceConfigOutput.md) | List of stage configurations | 
...
**health** | [**HealthCheckOutput**](HealthCheckOutput.md) | Health status and diagnostics | [optional] 
