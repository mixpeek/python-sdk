...
input_rendering_config_output_instance = InputRenderingConfigOutput.from_json(json)
# print the JSON string representation of the object
print(InputRenderingConfigOutput.to_json())

# convert the object into a dict
input_rendering_config_output_dict = input_rendering_config_output_instance.to_dict()
# create an instance of InputRenderingConfigOutput from a dict
input_rendering_config_output_from_dict = InputRenderingConfigOutput.from_dict(input_rendering_config_output_dict)
```
