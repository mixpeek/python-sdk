...
feature_search_config_instance = FeatureSearchConfig.from_json(json)
# print the JSON string representation of the object
print(FeatureSearchConfig.to_json())

# convert the object into a dict
feature_search_config_dict = feature_search_config_instance.to_dict()
# create an instance of FeatureSearchConfig from a dict
feature_search_config_from_dict = FeatureSearchConfig.from_dict(feature_search_config_dict)
```
