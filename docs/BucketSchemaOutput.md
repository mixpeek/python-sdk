...
bucket_schema_output_instance = BucketSchemaOutput.from_json(json)
# print the JSON string representation of the object
print(BucketSchemaOutput.to_json())

# convert the object into a dict
bucket_schema_output_dict = bucket_schema_output_instance.to_dict()
# create an instance of BucketSchemaOutput from a dict
bucket_schema_output_from_dict = BucketSchemaOutput.from_dict(bucket_schema_output_dict)
```
