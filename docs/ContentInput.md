...
json = "{}"
# create an instance of ContentInput from a JSON string
content_input_instance = ContentInput.from_json(json)
# print the JSON string representation of the object
print(ContentInput.to_json())

# convert the object into a dict
content_input_dict = content_input_instance.to_dict()
# create an instance of ContentInput from a dict
content_input_from_dict = ContentInput.from_dict(content_input_dict)
```
