...
**metadata** | **object** | Custom metadata applied to the organization. | [optional] 
...
**users** | **List[object]** | Deprecated nested user documents (maintained for backwards compatibility during migration). | [optional] 
