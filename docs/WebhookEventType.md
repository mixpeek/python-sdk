...
* `TAXONOMY_DOT_UPDATED` (value: `'taxonomy.updated'`)

* `TAXONOMY_DOT_DELETED` (value: `'taxonomy.deleted'`)

* `ALERT_DOT_CREATED` (value: `'alert.created'`)

* `ALERT_DOT_UPDATED` (value: `'alert.updated'`)

* `ALERT_DOT_DELETED` (value: `'alert.deleted'`)

* `ALERT_DOT_TRIGGERED` (value: `'alert.triggered'`)

* `ALERT_DOT_EXECUTION_DOT_COMPLETED` (value: `'alert.execution.completed'`)

* `ALERT_DOT_EXECUTION_DOT_FAILED` (value: `'alert.execution.failed'`)
