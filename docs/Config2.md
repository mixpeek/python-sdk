...
**step_analytics** | [**StepAnalyticsConfigOutput**](StepAnalyticsConfigOutput.md) | Optional configuration for step transition analytics. Enables tracking how documents progress through hierarchical taxonomy nodes over time (e.g., content workflow tracking from &#39;draft&#39; to &#39;published&#39;). If not provided, only basic assignment events are logged. | [optional] 
...
config2_from_dict = Config2.from_dict(config2_dict)
```
