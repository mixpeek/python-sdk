...
featured_gallery_config_output_instance = FeaturedGalleryConfigOutput.from_json(json)
# print the JSON string representation of the object
print(FeaturedGalleryConfigOutput.to_json())

# convert the object into a dict
featured_gallery_config_output_dict = featured_gallery_config_output_instance.to_dict()
# create an instance of FeaturedGalleryConfigOutput from a dict
featured_gallery_config_output_from_dict = FeaturedGalleryConfigOutput.from_dict(featured_gallery_config_output_dict)
```
