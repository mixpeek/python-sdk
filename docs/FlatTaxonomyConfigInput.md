...
**step_analytics** | [**StepAnalyticsConfigInput**](StepAnalyticsConfigInput.md) | Optional configuration for step transition analytics. Enables tracking how documents progress through taxonomy labels over time (e.g., email thread progression from &#39;inquiry&#39; to &#39;closed_won&#39;). If not provided, only basic assignment events are logged. | [optional] 
