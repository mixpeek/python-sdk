...
**parameter_schema** | **object** | Parameter schema JSON | [optional] 
**required_vector_indexes** | **List[object]** | Required vector indexes | [optional] 
**features** | **List[object]** | Features defined by the plugin (embeddings, scalars) | [optional] 
