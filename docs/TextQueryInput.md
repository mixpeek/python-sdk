...
json = "{}"
# create an instance of TextQueryInput from a JSON string
text_query_input_instance = TextQueryInput.from_json(json)
# print the JSON string representation of the object
print(TextQueryInput.to_json())

# convert the object into a dict
text_query_input_dict = text_query_input_instance.to_dict()
# create an instance of TextQueryInput from a dict
text_query_input_from_dict = TextQueryInput.from_dict(text_query_input_dict)
```
