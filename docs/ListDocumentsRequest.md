...
**return_presigned_urls** | **bool** | Whether to return presigned URLs for object keys. | [optional] [default to False]
**return_vectors** | **bool** | Whether to return vector embeddings in the document results. | [optional] [default to False]
**return_vector_names** | [**ReturnVectorNames**](ReturnVectorNames.md) |  | [optional] 
...
**limit** | **int** | Number of documents to return per page. | [optional] [default to 10]
**offset** | **int** | Number of documents to skip (offset-based pagination). | [optional] [default to 0]
