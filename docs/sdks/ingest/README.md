...
with Mixpeek(
    ...
    res = mixpeek.ingest.text(collection="col_1234567890", metadata={}, feature_extractors={
        "embed": [
            ...
            {
                "type": mixpeek.InputType.TEXT,
                "embedding_model": mixpeek.VectorModel.KEYWORD,
                "value": "https://example.com/image.jpg",
            },
            {
                "type": mixpeek.InputType.TEXT,
...
with Mixpeek(
    ...
    res = mixpeek.ingest.video_from_url(url="https://example.com/sample-video.mp4", collection="col_1234567890", metadata={}, feature_extractors=[
...
with Mixpeek(
    ...
    res = mixpeek.ingest.image_url(url="https://example.com/sample-video.mp4", collection="col_1234567890", metadata={}, feature_extractors=mixpeek.ImageSettings(
        read={
            "enabled": True,
        },
        embed=[
