...
json = "{}"
# create an instance of LogicalOperator1 from a JSON string
logical_operator1_instance = LogicalOperator1.from_json(json)
# print the JSON string representation of the object
print(LogicalOperator1.to_json())

# convert the object into a dict
logical_operator1_dict = logical_operator1_instance.to_dict()
# create an instance of LogicalOperator1 from a dict
logical_operator1_from_dict = LogicalOperator1.from_dict(logical_operator1_dict)
```
