...
stage_defs_facet_field_config_instance = StageDefsFacetFieldConfig.from_json(json)
# print the JSON string representation of the object
print(StageDefsFacetFieldConfig.to_json())

# convert the object into a dict
stage_defs_facet_field_config_dict = stage_defs_facet_field_config_instance.to_dict()
# create an instance of StageDefsFacetFieldConfig from a dict
stage_defs_facet_field_config_from_dict = StageDefsFacetFieldConfig.from_dict(stage_defs_facet_field_config_dict)
```
