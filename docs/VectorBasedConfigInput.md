...
**feature_extractor_name** | **str** | Internal field populated from feature_uri. Do not set manually. | [optional] 
**version** | **str** | Internal field populated from feature_uri. Do not set manually. | [optional] 
**output_name** | **str** | Internal field populated from feature_uri. Do not set manually. | [optional] 
...
vector_based_config_input_instance = VectorBasedConfigInput.from_json(json)
# print the JSON string representation of the object
print(VectorBasedConfigInput.to_json())

# convert the object into a dict
vector_based_config_input_dict = vector_based_config_input_instance.to_dict()
# create an instance of VectorBasedConfigInput from a dict
vector_based_config_input_from_dict = VectorBasedConfigInput.from_dict(vector_based_config_input_dict)
```
