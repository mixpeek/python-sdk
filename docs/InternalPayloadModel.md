...
**source_blobs** | **List[Dict[str, object]]** | Blobs that constituted the original source object. | [optional] 
**document_blobs** | **List[Dict[str, object]]** | Blobs generated during document processing (thumbnails, etc.). | [optional] 
**source_details** | **List[Dict[str, object]]** | Enrichment tracking and source detail entries. | [optional] 
**modality** | **str** | Content modality (text, image, video, audio, etc.). | [optional] 
**metadata** | **Dict[str, object]** | System metadata including ingestion_status, feature_extractor_config_hash, and other processing-related information. | [optional] 
