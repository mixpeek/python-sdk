...
stage_defs_feature_search_group_by_instance = StageDefsFeatureSearchGroupBy.from_json(json)
# print the JSON string representation of the object
print(StageDefsFeatureSearchGroupBy.to_json())

# convert the object into a dict
stage_defs_feature_search_group_by_dict = stage_defs_feature_search_group_by_instance.to_dict()
# create an instance of StageDefsFeatureSearchGroupBy from a dict
stage_defs_feature_search_group_by_from_dict = StageDefsFeatureSearchGroupBy.from_dict(stage_defs_feature_search_group_by_dict)
```
